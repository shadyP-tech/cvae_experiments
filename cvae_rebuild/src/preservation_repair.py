...
from splits import candidate_experts, stratified_source_train_val_split
...
def run_preservation_repair(cfg: RepairConfig, *, artifact_root: str | Path | None = None) -> Path:
    ...
    write_protocol_finalization(
        ...
        protocol_manifest=_protocol_manifest_payload(cfg),
...
def _protocol_manifest_payload(cfg: RepairConfig) -> dict[str, object]:
    return {

...
from reporting import prepare_artifact_dirs, validate_imported_artifacts, write_csv_rows, write_json, write_protocol_finalization
...
def _validate_imported_artifacts(cfg: SourceUnionBalancedGmmConfig) -> None:
    ...
    validate_imported_artifacts(
        required,
        missing_message="Missing imported balanced-GMM reference artifacts: {missing}",
    )

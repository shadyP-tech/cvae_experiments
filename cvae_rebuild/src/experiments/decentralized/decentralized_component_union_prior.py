...
def load_decentralized_component_union_prior_config(path: str | Path) -> ComponentUnionConfig:
    ...
    return parse_decentralized_component_union_prior_config(data, base_dir=config_base_dir_for_path(source))
...
def _write_artifacts(
    ...
    *,
    ...
    from decentralized_component_union_artifacts import _write_artifacts as write_component_union_artifacts

    write_component_union_artifacts(
        root,
        cfg,
        matrix_rows=matrix_rows,
        gap_rows=gap_rows,
        ...
        protocol_violations=protocol_violations,
        target_expert_excluded=target_expert_excluded,
        matched_shuffled_reliability_lambda=_matched_shuffled_reliability_lambda,
        matched_shuffled_reliability_null_rows=_matched_shuffled_reliability_null_rows,
        panel_summary_rows=_panel_summary_rows,
        shuffled_reliability_cell_delta_rows=_shuffled_reliability_cell_delta_rows,
        shuffled_reliability_center_summary_rows=_shuffled_reliability_center_summary_rows,
        random_mass_bag_control_summary_rows=_random_mass_bag_control_summary_rows,
        oracle_gap_summary_rows=_oracle_gap_summary_rows,
...
from component_union_rows import (
    _component_extend_row,
    _component_extend_rows,
    _eligibility_rows,
    _empty_matrix_row,
    _ineligible_rows,
    _reference_matrix_row,
    _rename_component_rows,
    _result_matrix_row,

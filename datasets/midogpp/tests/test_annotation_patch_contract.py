...
from midogpp_contract.builder import BuilderConfig, build_contract  # noqa: E402
from midogpp_contract.validation import ValidationError, validate_contract  # noqa: E402


SCHEMA_PATH = Path(__file__).resolve().parents[1] / "schemas/dataset_contract.schema.json"
...
def _config(
    ...
    *,
    ...
    artifact_root = repo_root / "datasets/midogpp/artifacts/midogpp_annotation_patch_v1"

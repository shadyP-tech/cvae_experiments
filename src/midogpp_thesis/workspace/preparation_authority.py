...
HARP_V10_EXECUTION_AMENDMENT_GATE = (
    "harp_v10_consumed_test_execution_amendment_v1"
)
HARP_V10_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v10"
)
HARP_V10_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V10_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V11_EXECUTION_AMENDMENT_GATE = (
    "harp_v11_consumed_test_execution_amendment_v1"
)
HARP_V11_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v11"
)
HARP_V11_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V11_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V12_EXECUTION_AMENDMENT_GATE = (
    "harp_v12_consumed_test_execution_amendment_v1"
)
HARP_V12_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v12"
)
HARP_V12_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V12_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V13_EXECUTION_AMENDMENT_GATE = (
    "harp_v13_consumed_test_execution_amendment_v1"
)
HARP_V13_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v13"
)
HARP_V13_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V13_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V14_EXECUTION_AMENDMENT_GATE = (
    "harp_v14_consumed_test_execution_amendment_v1"
)
HARP_V14_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v14"
)
HARP_V14_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V14_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V15_EXECUTION_AMENDMENT_GATE = (
    "harp_v15_consumed_test_execution_amendment_v1"
)
HARP_V15_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v15"
)
HARP_V15_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V15_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V16_EXECUTION_AMENDMENT_GATE = (
    "harp_v16_consumed_test_execution_amendment_v1"
)
HARP_V16_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v16"
)
...
HARP_V17_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v17"
)
...
HARP_V19_EXECUTION_AMENDMENT_GATE = (
    "harp_v19_consumed_test_execution_amendment_v1"
)
HARP_V20_EXECUTION_AMENDMENT_GATE = (
    "harp_v20_consumed_test_execution_amendment_v1"
)
HARP_V21_EXECUTION_AMENDMENT_GATE = (
    "harp_v21_consumed_test_execution_amendment_v1"
)
HARP_V18_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v18"
)
HARP_V19_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v19"
)
HARP_V20_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v20"
)
HARP_V21_EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v21"
)
HARP_V18_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V18_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V19_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V19_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V20_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V20_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
HARP_V21_RUN_CONFIRMATION_TOKEN = (
    "RUN_HARP_V21_TERMINAL_CONSUMED_TEST_DIAGNOSTIC"
)
...
_AUTHORITY_MODULE_BY_GATE = {
    ...
    HARP_V10_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v10."
        "workspace_preparation_authority",
        "HarpV10WorkspaceAuthorityError",
    ),
    HARP_V11_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v11."
        "workspace_preparation_authority",
        "HarpV11WorkspaceAuthorityError",
    ),
    HARP_V12_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v12."
        "workspace_preparation_authority",
        "HarpV12WorkspaceAuthorityError",
    ),
    HARP_V13_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13."
        "workspace_preparation_authority",
        "HarpV13WorkspaceAuthorityError",
    ),
    HARP_V14_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v14."
        "workspace_preparation_authority",
        "HarpV14WorkspaceAuthorityError",
    ),
    HARP_V15_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v15."
        "workspace_preparation_authority",
        "HarpV15WorkspaceAuthorityError",
    ),
    HARP_V16_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v16."
        "workspace_preparation_authority",
        "HarpV16WorkspaceAuthorityError",
    ),
    HARP_V17_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v17."
        "workspace_preparation_authority",
        "HarpV17WorkspaceAuthorityError",
    ),
    HARP_V18_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v18."
        "workspace_preparation_authority",
        "HarpV18WorkspaceAuthorityError",
    ),
    HARP_V19_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v19."
        "workspace_preparation_authority",
        "HarpV19WorkspaceAuthorityError",
    ),
    HARP_V20_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v20."
        "workspace_preparation_authority",
        "HarpV20WorkspaceAuthorityError",
    ),
    HARP_V21_EXECUTION_AMENDMENT_GATE: (
        "midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v21."
        "workspace_preparation_authority",
        "HarpV21WorkspaceAuthorityError",
    ),
    SCEPTRE_V4_EXECUTION_AMENDMENT_GATE: (
...
_HARP_VERSION_BY_GATE = {
    ...
    HARP_V10_EXECUTION_AMENDMENT_GATE: "v10",
    HARP_V11_EXECUTION_AMENDMENT_GATE: "v11",
    HARP_V12_EXECUTION_AMENDMENT_GATE: "v12",
    HARP_V13_EXECUTION_AMENDMENT_GATE: "v13",
    HARP_V14_EXECUTION_AMENDMENT_GATE: "v14",
    HARP_V15_EXECUTION_AMENDMENT_GATE: "v15",
    HARP_V16_EXECUTION_AMENDMENT_GATE: "v16",
    HARP_V17_EXECUTION_AMENDMENT_GATE: "v17",
    HARP_V18_EXECUTION_AMENDMENT_GATE: "v18",
    HARP_V19_EXECUTION_AMENDMENT_GATE: "v19",
    HARP_V20_EXECUTION_AMENDMENT_GATE: "v20",
    HARP_V21_EXECUTION_AMENDMENT_GATE: "v21",
}
...
_HARP_EXPERIMENT_BY_GATE = {
    ...
    HARP_V10_EXECUTION_AMENDMENT_GATE: HARP_V10_EXPERIMENT_ID,
    HARP_V11_EXECUTION_AMENDMENT_GATE: HARP_V11_EXPERIMENT_ID,
    HARP_V12_EXECUTION_AMENDMENT_GATE: HARP_V12_EXPERIMENT_ID,
    HARP_V13_EXECUTION_AMENDMENT_GATE: HARP_V13_EXPERIMENT_ID,
    HARP_V14_EXECUTION_AMENDMENT_GATE: HARP_V14_EXPERIMENT_ID,
    HARP_V15_EXECUTION_AMENDMENT_GATE: HARP_V15_EXPERIMENT_ID,
    HARP_V16_EXECUTION_AMENDMENT_GATE: HARP_V16_EXPERIMENT_ID,
    HARP_V17_EXECUTION_AMENDMENT_GATE: HARP_V17_EXPERIMENT_ID,
    HARP_V18_EXECUTION_AMENDMENT_GATE: HARP_V18_EXPERIMENT_ID,
    HARP_V19_EXECUTION_AMENDMENT_GATE: HARP_V19_EXPERIMENT_ID,
    HARP_V20_EXECUTION_AMENDMENT_GATE: HARP_V20_EXPERIMENT_ID,
    HARP_V21_EXECUTION_AMENDMENT_GATE: HARP_V21_EXPERIMENT_ID,
}
...
_HARP_RUN_CONFIRMATION_BY_GATE = {
    ...
    HARP_V10_EXECUTION_AMENDMENT_GATE: HARP_V10_RUN_CONFIRMATION_TOKEN,
    HARP_V11_EXECUTION_AMENDMENT_GATE: HARP_V11_RUN_CONFIRMATION_TOKEN,
    HARP_V12_EXECUTION_AMENDMENT_GATE: HARP_V12_RUN_CONFIRMATION_TOKEN,
    HARP_V13_EXECUTION_AMENDMENT_GATE: HARP_V13_RUN_CONFIRMATION_TOKEN,
    HARP_V14_EXECUTION_AMENDMENT_GATE: HARP_V14_RUN_CONFIRMATION_TOKEN,
    HARP_V15_EXECUTION_AMENDMENT_GATE: HARP_V15_RUN_CONFIRMATION_TOKEN,
    HARP_V16_EXECUTION_AMENDMENT_GATE: HARP_V16_RUN_CONFIRMATION_TOKEN,
    HARP_V17_EXECUTION_AMENDMENT_GATE: HARP_V17_RUN_CONFIRMATION_TOKEN,
    HARP_V18_EXECUTION_AMENDMENT_GATE: HARP_V18_RUN_CONFIRMATION_TOKEN,
    HARP_V19_EXECUTION_AMENDMENT_GATE: HARP_V19_RUN_CONFIRMATION_TOKEN,
    HARP_V20_EXECUTION_AMENDMENT_GATE: HARP_V20_RUN_CONFIRMATION_TOKEN,
    HARP_V21_EXECUTION_AMENDMENT_GATE: HARP_V21_RUN_CONFIRMATION_TOKEN,
}

"""Thin, phase-ordered runner for the terminal PSSCUR diagnostic."""
...
def run_p_anchored_simultaneous_shift_calibrated_utility_router(
    config: object,
    *,
    ...
    with exclusive_run_lock(root):
        ...
        try:
            ...
            phase = (
                "OUTER_LOO_ENDPOINTS_FIVE_FOLD_POSTERIORS_AND_"
                "SIMULTANEOUS_SHIFT_CALIBRATED_ROUTING"
            )
            write_state(root, status="RUNNING", phase=phase)
            _observe(phase_observer, phase)
...
run_psscur = run_p_anchored_simultaneous_shift_calibrated_utility_router


__all__ = ("run_p_anchored_simultaneous_shift_calibrated_utility_router", "run_psscur")

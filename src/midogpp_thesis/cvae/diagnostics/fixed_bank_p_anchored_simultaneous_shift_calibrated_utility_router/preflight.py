...
SCHEMA = "fixed_bank_psscur_workstation_preflight_v1"
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        raise ProtocolError("PSSCUR persisted workstation preflight drifted.")
    return payload

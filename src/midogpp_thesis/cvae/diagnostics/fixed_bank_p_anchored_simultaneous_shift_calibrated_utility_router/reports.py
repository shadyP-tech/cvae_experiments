...
def protocol_manifest_payload(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_psscur_protocol_manifest_v1",
...
def leakage_report_payload(
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_psscur_leakage_report_v1",
        "status": "PASS",
        ...
        "target_posterior_uses_five_whole_case_support_folds": True,
        "target_posterior_OOF_reliability_is_route_local": True,
        ...
        "nested_leave_one_donor_envelope_replay_used": True,
        "held_case_shift_features_are_label_free": True,
        "simultaneous_maximum_precedes_envelope_quantile": True,
...
def publication_decision_payload(terminal: object) -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_psscur_publication_decision_v1",
        ...
        "unconfirmed_thesis_specific_mechanism_hypothesis": (
            "P-anchored_five-fold_target-local_posterior_expected-utility_"
            "with_partially-pooled_simultaneous_donor-residual_envelopes_"
            "label-free_shift-inflation_lower-tail-safety_and_P-fallback"
        ),
...
def run_state_payload(
    *,
    ...
    return {
        "schema_version": "fixed_bank_psscur_run_state_v1",
        "status": status,
        "phase": phase,
        "error": error,

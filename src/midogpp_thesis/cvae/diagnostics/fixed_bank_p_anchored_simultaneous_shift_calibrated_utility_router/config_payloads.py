"""Canonical executable config sections for PSSCUR."""
...
def canonical_action_library_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_psscur_action_library_v1",
...
def canonical_policy_menu_payload() -> dict[str, object]:
    return {
        ...
        "minimax_envelope_control_id": MINIMAX_CONTROL_METHOD_ID,
        ...
        "target_score": "shift_inflated_simultaneous_lower_BACC_bound",
        "target_posterior": {
        ...
        "envelope_calibration": (
            "selection_aware_directional_donor_block_maximum_quantile"
        ),
        ...
        "primary_gate": (
            "authorized_nonvacuous_envelope_and_reliable_and_lower_BACC_gt_0_"
            "and_upper_Brier_le_0_and_upper_log_loss_le_0"
        ),
...
def canonical_evaluation_payload() -> dict[str, object]:
    return {
        ...
        "posterior_utility_information_diagnostics": [
            ...
            "simultaneous_bound_coverage_and_shift_inflation_by_center",
        ],
        "oracle_diagnostics": [
...
def canonical_runtime_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_psscur_workstation_runtime_v1",
        ...
        "expected_envelope_calibration_count": EXPECTED_ENVELOPE_CALIBRATION_COUNT,
...
def canonical_claim_boundary_payload() -> dict[str, object]:
    return {
        ...
        "bounded_interpretation": (
            "target_support_conditioned_simultaneous_shift_calibrated_utility_"

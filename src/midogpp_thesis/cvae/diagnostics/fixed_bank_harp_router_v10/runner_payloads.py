"""Pure manifest builders for the HARP v10 execution lifecycle.
...
def build_development_surface_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_development_surface_seal_v1",
...
def build_model_lock(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_model_lock_v1",
...
def build_policy_admission_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_source_policy_admission_seal_v1",
            "config_hash": config_hash,
            "model_hash": fitted.manifest["model_hash"],
...
def build_target_action_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_target_action_seal_v1",
...
def build_prelabel_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_prelabel_route_bundle_v1",
...
def build_validation_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_fresh_validation_bundle_v1",
            "config_hash": config_hash,
            "expected_center_ids": list(centers),
...
def build_frozen_route_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v10_frozen_route_seal_v1",
...
def build_run_state(
    *,
    ...
    return {
        "schema_version": "midogpp_harp_v10_run_state_v1",

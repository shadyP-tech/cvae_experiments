"""Typed identities for archived HARP v10 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V10_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v10"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v10"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v10/superseded_activations"
)
...
class HarpV10ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV10ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV10ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

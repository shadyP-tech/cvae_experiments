"""Frozen identities and numerical constants for the CBPUPR v3 repair.
...
EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_p_anchored_route_"
    "scoped_center_balanced_posterior_utility_prefix_router.v3"
)
EXPERIMENT_NAME = (
    "uniform_b_v2_consumed_test_fixed_bank_p_anchored_route_scoped_center_"
    "balanced_posterior_utility_prefix_router_v3"
)
...
EXECUTION_REVISION = "v3_global_and_center_surface_lineage_mechanical_repair"
EXECUTION_SCHEMA_REVISION = "fixed_bank_cbpupr_execution_schema_v3"
REPAIR_CODE_IDENTITY = (
    "cbpupr_v3_explicit_global_and_center_surface_lineage"
)
REPAIR_BASE_COMMIT = "295b5718e805fc948bcc99be3d92084978be6c8d"
V1_FAILURE_PHASE = "CONTENT_AND_TWO_FRESH_PROCESS_VALIDATION"
V1_FAILURE_EXCEPTION = "posterior_prediction_model_lineage_order_drift"
V2_FAILURE_PHASE = "ROUTE_ENDPOINTS_436_POSTERIORS_AND_CANDIDATE_SEAL"
V2_FAILURE_EXCEPTION = "global_surface_hash_compared_to_center_surface_hash"
...
SCRATCH_ROOT = (
    "/data/local/fixed_bank_p_anchored_route_scoped_center_balanced_"
    "posterior_utility_prefix_router_v3"
)
RUN_RECOVERY_POLICY = (

...
def validate_seal_chain(
    ...
    *,
    ...
    preterminal_hash = validate_preterminal_seal_chain(
        ...
        expected_gate_funnel=expected_gate_funnel,
    )
    ...
    return preterminal_hash


def validate_preterminal_seal_chain(
    root: Path,
    *,
    physical: Row,
    plan_topology: PlanPosteriorTopology,
    ...
    """Reconstruct every label-free seal through the aggregate barrier."""
    ...
    if aggregate.get("preterminal_hash") != expected_preterminal_hash:
        fail("preterminal aggregate lineage")
    return expected_preterminal_hash


def validate_terminal_seal_chain(
    root: Path,
    *,
    capability: Row,
    method_metrics: Sequence[Row],
    ...
    """Validate only the terminal extension of an already rebuilt barrier."""
    ...
    if (
        aggregate.get("preterminal_hash") != preterminal_hash
        or summary.get("preterminal_hash") != preterminal_hash

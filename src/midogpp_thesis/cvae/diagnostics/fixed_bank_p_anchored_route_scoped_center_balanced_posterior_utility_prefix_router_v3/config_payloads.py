"""Canonical executable config sections for the terminal-only CBPUPR v3 repair."""
...
from .experiment_contracts import AUTHORIZATION_BASIS, WORKSPACE_ALIAS_PLACEHOLDER_IDS
...
def canonical_runtime_payload() -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_cbpupr_workstation_runtime_v3",
...
def canonical_claim_boundary_payload() -> dict[str, object]:
    source_identity = source_seal_identity()
    return {
        "schema_version": "fixed_bank_cbpupr_claim_boundary_v3",
        ...
        "workspace_registry_entry_required": True,
        "fresh_v3_workspace_alias_placeholders": list(

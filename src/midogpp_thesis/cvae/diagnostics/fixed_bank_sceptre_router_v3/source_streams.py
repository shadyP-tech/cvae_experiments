...
def materialize_source_streams(
    ...
    *,
    ...
    index_unhashed = {
        "schema_version": "midogpp_sceptre_v3_source_stream_index_v1",
    ...
    receipt_unhashed = {
        "schema_version": "midogpp_sceptre_v3_source_stream_receipt_v1",
...
def load_source_streams(
    ...
    *,
    ...
    if (
        ...
        != "midogpp_sceptre_v3_source_stream_index_v1"
        or receipt.get("schema_version")
        != "midogpp_sceptre_v3_source_stream_receipt_v1"
...
def _build_tasks(
    ...
    *,
    ...
    for ordinal, (source, training_seed) in enumerate(
        ...
        task_identity = {
            "schema_version": "midogpp_sceptre_v3_source_task_v1",
...
def _publish_checkpoint(
    ...
    *,
    ...
    checkpoint_unhashed = {
        "schema_version": "midogpp_sceptre_v3_source_checkpoint_v1",
        "status": "COMPLETE",
...
def _load_checkpoint_if_complete(
    ...
    if (
        ...
        != "midogpp_sceptre_v3_source_checkpoint_v1"

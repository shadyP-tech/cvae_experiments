"""Immutable, label-free consumed-test DTOs for SCEPTRE v3."""
...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("SCEPTRE v3 test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v3 label-free frame drifted.")
        if self.canonical_coverage and (
            ...
            raise ProtocolError("SCEPTRE v3 canonical whole-case coverage drifted.")
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "sceptre_v3_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v3 embedding identity drifted.")

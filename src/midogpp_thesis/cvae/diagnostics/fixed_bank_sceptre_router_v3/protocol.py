"""Frozen scientific and claim protocol for executable SCEPTRE v3."""
...
PROTOCOL_SCHEMA = "sceptre_v3_executable_terminal_protocol_v1"
...
def frozen_protocol_payload() -> dict[str, object]:
    payload: dict[str, object] = {
        ...
        "prelease_worker_runtime_smoke": {
            "required": True,
            "uses_exact_production_gpu_initializer": True,
            "repeated_tasks_per_persistent_worker": 2,
            "scientific_source_generation_started": False,
            "expert_checkpoints_opened": False,
            "target_cache_or_manifest_opened": False,
            "target_labels_opened": False,
            "filesystem_mutations": 0,
            "smoke_hash_bound_to_authorization_lease": True,
        },
        ...
        "v2_failed_execution_used": False,
...
def claim_boundary_payload() -> dict[str, object]:
    return {
        "schema_version": "sceptre_v3_claim_boundary_v1",
        "experiment_id": EXPERIMENT_ID,
        "publication_status": PUBLICATION_STATUS,
        "terminal_decision": TERMINAL_DECISION,
        ...
        "may_feed_another_experiment": False,
        "prelease_worker_smoke_is_scientific_execution": False,
...
def validate_protocol_payload(payload: Mapping[str, object]) -> None:
    if dict(payload) != frozen_protocol_payload():
        raise ProtocolError("SCEPTRE v3 scientific protocol drifted.")
    if (
        ...
        raise ProtocolError("SCEPTRE v3 claim firewall drifted.")

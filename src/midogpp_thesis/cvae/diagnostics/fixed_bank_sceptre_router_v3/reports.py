"""Terminal SCEPTRE v3 reports with permanent claim-boundary language."""
...
def build_final_reports(
    ...
    *,
    ...
    summary = {
        "schema_version": "sceptre_v3_diagnostic_summary_v1",
    ...
    leakage = {
        "schema_version": "sceptre_v3_leakage_report_v1",
        "status": "PASS",
    ...
    publication = {
        "schema_version": "sceptre_v3_publication_decision_v1",
    ...
    runtime_report = {
        "schema_version": "sceptre_v3_runtime_summary_v1",
    ...
    boundary = {
        **publication,
        "schema_version": "sceptre_v3_claim_boundary_report_v1",
        "interpretation": (
...
def build_validation_report(payload: Mapping[str, object]) -> dict[str, object]:
    ...
    body = {
        "schema_version": "sceptre_v3_final_validation_report_v1",
        "status": "PASS",

"""Exact-eight executable inputs and immutable SCEPTRE v3 anchors."""
...
CANONICAL_SCRATCH_ROOT = "/data/local/fixed_bank_sceptre_router_v3"
...
TEST_CACHE_ARTIFACT_ID = "midogpp_stage90_sceptre_test_cache_v3"
TEST_MANIFEST_ARTIFACT_ID = "midogpp_stage90_sceptre_test_manifest_v3"
TEST_CONSUMPTION_LEDGER_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_parent_v3"
)
EXECUTION_AMENDMENT_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_execution_amendment_v3"
)
SOURCE_INNER_ORIGINAL_ARTIFACT_ID = (
    "midogpp_output_uniform_b_v2_source_inner_candidate_utility_v1"
)

SOURCE_INNER_AMENDMENT_FILENAME = "source_inner_adaptive_reuse_amendment_v3.json"
EXECUTION_AMENDMENT_FILENAME = "sceptre_v3_execution_amendment.json"
...
AUTHORIZED_INPUT_ROLES = (
    ...
    "consumer_fenced_v3_source_inner_seven_member_alias",
    "v3_source_inner_adaptive_development_amendment",
    "v3_label_free_consumed_test_cache_alias",
    "v3_role_scoped_consumed_test_manifest_alias",
    "exact_parent_test_consumption_ledger_alias",
    "v3_single_use_execution_amendment",
)
...
EXPECTED_SOURCE_INNER_AMENDMENT_SHA256 = (
    "cafd09003b58a2f797a6566d4758906b2a20d4d18866feb080fdbe1f7cccc110"
)

EXPECTED_EXECUTION_AMENDMENT_SHA256 = (
    "87440f9ee4e49d9f4bb07e3647762072c271317006918b7e5612b32ceccf49e6"
)
...
FORBIDDEN_INPUT_FRAGMENTS = (
    ...
    "midogpp_stage90_sceptre_test_cache_v2",
    "midogpp_stage90_sceptre_test_manifest_v2",
...
SOURCE_INNER_AMENDMENT_RELATIVE_PATH = (
    ...
    "sceptre_router_v3/source_inner_adaptive_reuse_amendment_v3.json"
)

"""Frozen claim and package identities for SCEPTRE v4."""
...
PACKAGE_NAME = "fixed_bank_sceptre_router_v4"
EXPERIMENT_ID = (
    "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_sceptre_router.v4"
)
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_sceptre_router_v4"
OUTPUT_ARTIFACT_ID = f"midogpp_output_{EXPERIMENT_NAME}"
CLI_SURFACE = "fixed-bank-sceptre-router-v4"
...
AUTHORIZATION_BASIS = (
    "explicit_user_authorization_2026_08_28_for_sceptre_v4_terminal_"
    "consumed_test_diagnostic_runner"
)
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_fixed_bank_sceptre_router_v4_diagnostic"
)
AUTHORIZATION_DATE = "2026-08-28"
EXECUTION_REVISION = "v4_candidate_set_terminal_consumed_test_diagnostic"

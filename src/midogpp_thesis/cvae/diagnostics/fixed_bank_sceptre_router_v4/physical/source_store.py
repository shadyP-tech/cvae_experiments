"""Publication and validation of the sealed v4 source-stream store."""
...
def publish_source_store(
    ...
    *,
    ...
    index_unhashed = {
        "schema_version": "midogpp_sceptre_v4_physical_source_stream_index_v1",
    ...
    receipt_unhashed = {
        "schema_version": "midogpp_sceptre_v4_physical_source_stream_receipt_v1",
...
def load_source_streams(
    ...
    *,
    ...
    if any(
        ...
        raise ProtocolError("SCEPTRE v4 source final store is absent or unsafe.")
    index = read_json(index_path)
    receipt = read_json(receipt_path)
    raw_records = index.get("records")
    if not isinstance(raw_records, list):
        raise ProtocolError("SCEPTRE v4 source index records are absent.")
    try:
        records = tuple(
            SourceStreamRecord(
        ...
        raise ProtocolError("SCEPTRE v4 source index record is malformed.") from exc
    index_unhashed = {
    ...
    if (
        ...
        != "midogpp_sceptre_v4_physical_source_stream_index_v1"
        or receipt.get("schema_version")
        != "midogpp_sceptre_v4_physical_source_stream_receipt_v1"
        ...
        raise ProtocolError("SCEPTRE v4 source receipt failed validation.")
    ...
    if (
        ...
        raise ProtocolError("SCEPTRE v4 source array geometry or values drifted.")
    ...
    for record in records:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v4 source block bytes drifted.")
    return store

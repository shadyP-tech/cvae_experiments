"""Authorization and workspace-provenance reconstruction for SCEPTRE v4."""
...
def validate_preterminal_authority(
    ...
    if not all(
        ...
        raise ProtocolError("SCEPTRE v4 preterminal authority graph is malformed.")
    ...
    if not isinstance(preflight, Mapping) or not isinstance(smoke, Mapping):
        raise ProtocolError("SCEPTRE v4 persisted runtime admission is malformed.")
    ...
    if not isinstance(raw_rows, list) or not all(
        ...
        raise ProtocolError("SCEPTRE v4 persisted workspace provenance is malformed.")
    ...
    if (
        ...
        != "sceptre_v4_admitted_input_binding_v1"
        ...
        raise ProtocolError("SCEPTRE v4 preterminal authority lineage drifted.")

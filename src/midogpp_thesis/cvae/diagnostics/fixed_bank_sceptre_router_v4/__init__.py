"""SCEPTRE v4 candidate-set routing diagnostic.

The package is intentionally separate from the sealed SCEPTRE v3 source
closure.  It implements the transition

"""Exact-eight executable inputs and immutable SCEPTRE v4 anchors."""
...
CANONICAL_SCRATCH_ROOT = "/data/local/fixed_bank_sceptre_router_v4"
...
SOURCE_INNER_ALIAS_ARTIFACT_ID = (
    "midogpp_stage90_sceptre_source_inner_candidate_utility_reuse_v4"
)
SOURCE_INNER_AMENDMENT_ARTIFACT_ID = (
    "midogpp_stage90_sceptre_source_inner_adaptive_reuse_amendment_v4"
)
TEST_CACHE_ARTIFACT_ID = "midogpp_stage90_sceptre_test_cache_v4"
TEST_MANIFEST_ARTIFACT_ID = "midogpp_stage90_sceptre_test_manifest_v4"
TEST_CONSUMPTION_LEDGER_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_parent_v4"
)
EXECUTION_AMENDMENT_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_execution_amendment_v4"
)
SOURCE_INNER_ORIGINAL_ARTIFACT_ID = (
    "midogpp_output_uniform_b_v2_source_inner_candidate_utility_v1"
)

SOURCE_INNER_AMENDMENT_FILENAME = "source_inner_adaptive_reuse_amendment_v4.json"
EXECUTION_AMENDMENT_FILENAME = "sceptre_v4_execution_amendment.json"
...
AUTHORIZED_INPUT_ROLES = (
    ...
    "consumer_fenced_v4_source_inner_seven_member_alias",
    "v4_source_inner_complete_ranking_prior_amendment",
    "v4_label_free_consumed_test_cache_alias",
    "v4_role_scoped_consumed_test_manifest_alias",
    "exact_parent_test_consumption_ledger_alias",
    "v4_single_use_execution_amendment",
)
...
EXPECTED_SOURCE_INNER_AMENDMENT_SHA256 = (
    "6d84a82a63e97f96e6934143a3007f4d8af92a019e28b7ab512c71071730db00"
)
...
SOURCE_INNER_AMENDMENT_RELATIVE_PATH = (
    ...
    "sceptre_router_v4/source_inner_adaptive_reuse_amendment_v4.json"
)

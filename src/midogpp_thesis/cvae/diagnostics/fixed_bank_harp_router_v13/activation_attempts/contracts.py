"""Typed identities for archived HARP v13 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V13_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v13"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v13"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v13/superseded_activations"
)
...
ACTIVE_SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V13_ACTIVE_UNCONSUMED_PRELEASE_ACTIVATION_FOR_REPLANNING"
)
ACTIVE_SUPERSESSION_PLAN_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_plan_v13"
)
ACTIVE_SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_receipt_v13"
)
...
RETIREMENT_FENCE_SCHEMA = "midogpp_harp_v13_active_supersession_retirement_fence_v1"
ACTIVE_SUPERSESSION_RECEIPT = "active_supersession_receipt.json"


@dataclass(frozen=True, slots=True)
class HarpV13ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV13ActivationSupersessionReceipt:
...
@dataclass(frozen=True, slots=True)
class HarpV13ActiveActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV13ActiveActivationSupersessionReceipt:
    payload: Mapping[str, object]
...
def receipt_payload(plan: HarpV13ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

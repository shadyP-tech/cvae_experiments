"""Immutable identity and claim boundary for the HARP v13 router."""
...
EXPERIMENT_ID = "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v13"
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_harp_router_v13"
OUTPUT_ARTIFACT_ID = "midogpp_output_uniform_b_v2_consumed_test_fixed_bank_harp_router_v13"
PUBLICATION_STATUS = "POST_HOC_CONSUMED_TEST_SENSITIVITY"
TERMINAL_DECISION = "TERMINAL_DIAGNOSTIC_ONLY_DO_NOT_PROMOTE"
CLAIM_SCOPE = "diagnostic_only"
EXECUTION_REVISION = (
    "v13_source_train_crossfit_full_test_exact_fold_menu_binding_"
    "policy_risk_coverage_exact_top1"
)
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_harp_v13_"
...
def authorization_input_binding_payload(
    *,
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_authorized_input_binding_v13",
...
def claim_boundary_payload(*, execution_authorized: bool) -> dict[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_claim_boundary_v13",
        "experiment_id": EXPERIMENT_ID,

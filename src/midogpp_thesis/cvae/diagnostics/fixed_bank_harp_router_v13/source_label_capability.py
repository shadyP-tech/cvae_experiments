"""Typed source-label capabilities for HARP v13 nested cross-fitting.
...
class FoldSourceLabelCapability:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v13 fold source-label capability is malformed.")
    ...
    def authorize(self, allowed_center_ids: Sequence[str]) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v13 fold source-label capability is cross-scoped.")
...
class AggregateSourceLabelCapability:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v13 aggregate source-label capability is malformed.")
        body = {
            "schema_version": "midogpp_harp_v13_aggregate_source_label_capability_v1",
            "source_surface_receipt_hash": receipt.receipt_hash,
            "source_surface_hash": receipt.surface_hash,
    ...
    def authorize(self, allowed_center_ids: Sequence[str]) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v13 aggregate source-label capability is cross-scoped.")
...
def issue_fold_source_label_capability(
    *,
    ...
    if (
        ...
        raise ProtocolError("HARP v13 effective/physical crossfit surfaces are unbound.")
    ...
    if (
        ...
        raise ProtocolError("HARP v13 fold effective inventory crossed H/q.")
...
def _fresh_receipt(receipt: object) -> SourceCrossfitSurfaceReceipt:
    if not isinstance(receipt, SourceCrossfitSurfaceReceipt):
        raise ProtocolError("HARP v13 source labels require a typed physical receipt.")

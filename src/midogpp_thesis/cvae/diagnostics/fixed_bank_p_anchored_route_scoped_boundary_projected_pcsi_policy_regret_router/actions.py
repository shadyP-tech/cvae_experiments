...
class ActionSpec:
    ...
    def __post_init__(self) -> None:
        ...
        unhashed = {
            "schema_version": "fixed_bank_pcsi_racr_action_v1",
        ...
        # Action identities are persisted scientific contracts.  Keep them on
        # the full canonical SHA-256 boundary required by the neutral fixed-bank
        # prediction runtime, rather than using a short repository identity.
        object.__setattr__(self, "action_hash", canonical_hash(unhashed))

"""Bias-corrected donor-deletion predictions for PCSI-RACR surfaces."""
    ...
    *,
    ...
    for row in rows:
        ...
        if (
            ...
            raise ProtocolError("PCSI-RACR delete-donor model topology drifted.")
        ...
        for direction in DIRECTION_IDS:
            ...
            for donor in delete_models:
                ...
                if (
                    ...
                    raise ProtocolError("PCSI-RACR residual calibration lacks a direction block.")
...
def predict_projected_surface(
    ...
    *,
    ...
    if (
        ...
        raise ProtocolError("PCSI-RACR actual/pseudo prediction scope drifted.")
    ...
    for descriptor in descriptors:
        if (
            ...
            raise ProtocolError("PCSI-RACR model/descriptor topology drifted.")

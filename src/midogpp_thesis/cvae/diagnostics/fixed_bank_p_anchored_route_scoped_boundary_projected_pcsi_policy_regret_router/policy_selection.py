...
class DirectionalClassDecision:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-RACR directional decision drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_racr_directional_decision_v1",
...
class CaseCandidatePolicy:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-RACR candidate case policy drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_racr_case_candidate_policy_v1",
            "target_center": self.target_center,
            "case_id": self.case_id,
            "policy_id": self.policy_id,
...
class FinalCasePolicyPrediction:
    ...
    def __post_init__(self) -> None:
        ...
        if not samples or len(samples) != len(probabilities):
            raise ProtocolError("PCSI-RACR final prediction topology drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_racr_final_case_prediction_v1",
            "target_center": self.target_center,
            "case_id": self.case_id,
            "policy_id": self.policy_id,
            "sample_ids": list(self.sample_ids),
...
def select_and_compose_case_policy(
    ...
    *,
    ...
    if (
        ...
        raise ProtocolError("PCSI-RACR case selection surface drifted.")
    ...
    for direction in DIRECTION_IDS:
        ...
        for descriptor in direction_rows:
            ...
            if (
                ...
                raise ProtocolError("PCSI-RACR influence/utility binding drifted.")
        ...
        if selected is None:
            ...
            if np.any(mask & occupied):
                raise ProtocolError("PCSI-RACR opposing direction masks overlap.")
    ...
    if len(geometry_ids) != 1:
        raise ProtocolError("PCSI-RACR one case spans action geometries.")
...
def finalize_case_policy(
    ...
    *,
    ...
    if candidate.target_center != endpoint.center or candidate.case_id != endpoint.case_id:
        raise ProtocolError("PCSI-RACR finalization crossed a case.")
    probabilities = (

"""Thin, phase-ordered runner for the terminal PCSI-RACR diagnostic."""
...
def run_p_anchored_route_scoped_boundary_projected_pcsi_policy_regret_router(
    config: object,
    *,
...
def _engine_phase_observer(
    ...
    *,
    ...
    phase_names = {
        ...
        "donor_utility": "PROJECTED_AND_RAW_ROUTE_SCOPED_UTILITY_FITS",
    ...
    def observe(event: str, counts: Mapping[str, int]) -> None:
        ...
        if not event.endswith("_completed"):
            raise RuntimeError(f"Unknown PCSI-RACR engine phase event: {event}.")
...
run_pcsi = run_p_anchored_route_scoped_boundary_projected_pcsi_policy_regret_router


__all__ = ("run_p_anchored_route_scoped_boundary_projected_pcsi_policy_regret_router", "run_pcsi")

...
SCHEMA = "fixed_bank_pcsi_workstation_preflight_v1"
...
def run_workstation_preflight(
    ...
    if (
        ...
        raise ProtocolError("PCSI recovery policy drifted.")
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        raise ProtocolError("PCSI persisted workstation preflight drifted.")
    return payload

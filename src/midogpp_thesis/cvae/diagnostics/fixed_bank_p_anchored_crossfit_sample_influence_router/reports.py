...
def protocol_manifest_payload(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pcsi_protocol_manifest_v1",
...
def leakage_report_payload(
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pcsi_leakage_report_v1",
        "status": "PASS",
        ...
        "complete_delete_one_donor_veto_set_used": True,
...
def publication_decision_payload(terminal: object) -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_pcsi_publication_decision_v1",
        ...
        "unconfirmed_thesis_specific_mechanism_hypothesis": (
            "P-anchored_crossfit_target-local_sample_influence_with_natural-"
            "prevalence_correction_outer-center-excluded_donor_Pareto_veto_"
...
def run_state_payload(
    *,
    ...
    return {
        "schema_version": "fixed_bank_pcsi_run_state_v1",
        "status": status,
        "phase": phase,
        "error": error,

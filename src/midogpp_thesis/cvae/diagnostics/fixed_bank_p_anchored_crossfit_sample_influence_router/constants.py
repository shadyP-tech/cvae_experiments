"""Frozen constants for the P-anchored cross-fit sample-influence router.
...
EXPERIMENT_ID = (
    ...
    "p_anchored_crossfit_sample_influence_router.v1"
)
EXPERIMENT_NAME = (
    "uniform_b_v2_consumed_test_fixed_bank_"
    "p_anchored_crossfit_sample_influence_router_v1"
)
OUTPUT_ARTIFACT_ID = (
...
CLAIM_ROLE = (
    "posthoc_fixed_bank_p_anchored_crossfit_sample_influence_router_"
    "diagnostic"
)
...
MODEL_BASED_METHOD_ID = "PCSI_DUAL_VETO"
BACC_ONLY_METHOD_ID = "PCSI_SCORE_ONLY"
FULL_ONLY_METHOD_ID = "PCSI_PROPER_ONLY"
PERMUTATION_METHOD_ID = "PCSI_BLOCKED_FINGERPRINT"
COMPOSED_POLICY_IDS = (
...
# One full plus eight delete-donor fits for every outer target.  The blocked
# control acts on the target fingerprint, so the donor veto is fit only once.
EXPECTED_UTILITY_MODEL_FIT_COUNT = len(CENTERS) * len(CENTERS)
...
SCRATCH_ROOT = "/data/local/fixed_bank_p_anchored_crossfit_sample_influence_router_v1"

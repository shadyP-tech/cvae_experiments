...
def select_directional_actions(
    ...
    *,
    ...
    if (
        ...
        raise ProtocolError("PCSI directional selection rectangle drifted.")
    center = rows[0].target_center
    case = rows[0].case_id
    if any(row.target_center != center or row.case_id != case for row in rows):
        raise ProtocolError("PCSI directional selection spans cases.")
    ...
    for direction in DIRECTION_IDS:
        ...
        for descriptor in direction_rows:
            ...
            if (
                ...
                raise ProtocolError("PCSI influence/descriptor binding drifted.")

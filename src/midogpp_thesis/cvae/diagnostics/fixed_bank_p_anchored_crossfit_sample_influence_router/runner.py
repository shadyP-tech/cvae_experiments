"""Thin, phase-ordered runner for the terminal PCSI diagnostic."""
...
def run_p_anchored_crossfit_sample_influence_router(
    config: object,
    *,
...
run_pcsi = run_p_anchored_crossfit_sample_influence_router


__all__ = ("run_p_anchored_crossfit_sample_influence_router", "run_pcsi")

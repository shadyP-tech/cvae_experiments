"""Leakage, routing, and terminal report construction for HARP v7."""
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v7_leakage_report_v1",
        ...
        "source_case_opportunity_hurdle_includes_empty_active_menus": True,
        "conditional_D01_D10_ranker": True,
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v7_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v7_validation_report_v1",
        "status": "PASS",

"""Immutable identities and data contracts for HARP v7 input preparation."""
...
from .input_surfaces import HarpConsumedCacheIdentity, V7_CACHE_IDENTITY
...
# revision. HARP v7 owns a distinct derived cache while deliberately reusing
...
PREPARATION_RECEIPT = Path("manifests/harp_v7_consumed_test_preparation_receipt.json")
LABEL_FREE_BARRIER = Path("manifests/harp_v7_label_free_partition_barrier.json")
LABEL_FREE_CONTENT_INDEX = Path("manifests/harp_v7_label_free_content_index.json")
CASE_PARTITION = Path("manifests/harp_v7_case_partition.json")
METADATA_FIELDS = {
    "evaluation_row_id",
    "contract_row_index",
    "case_id",
...
V7_PREPARATION_IDENTITY = HarpPreparationIdentity(
    experiment_id=EXPERIMENT_ID,
    publication_status=PUBLICATION_STATUS,
    terminal_decision=TERMINAL_DECISION,
    prepared_inputs_schema="midogpp_harp_consumed_test_prepared_inputs_v7",
    partition_schema="midogpp_harp_consumed_test_case_partition_v7",
    preparation_receipt_schema="midogpp_harp_consumed_test_preparation_receipt_v7",
    label_free_barrier_schema="midogpp_harp_consumed_test_label_free_barrier_v7",
    cache_identity=V7_CACHE_IDENTITY,
)
...
class HarpV7PreparedInputs:
    ...
    def to_payload(self) -> dict[str, object]:
        ...
        return {
            "schema_version": "midogpp_harp_consumed_test_prepared_inputs_v7",

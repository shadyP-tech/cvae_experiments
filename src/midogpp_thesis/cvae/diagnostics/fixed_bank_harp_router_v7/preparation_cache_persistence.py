"""Persistence and independent validation of the HARP v7 label-free cache."""
...
def independently_validate_label_blind_barrier(
    ...
    *,
    ...
    if identity.cache_identity != V7_CACHE_IDENTITY:
        raise ProtocolError("HARP v7 preparation cache identity drifted.")

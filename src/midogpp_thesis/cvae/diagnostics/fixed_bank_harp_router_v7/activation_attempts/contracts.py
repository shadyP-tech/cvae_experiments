"""Typed identities for archived HARP v7 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V7_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v7"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v7"
)
SUPERSESSION_REASON = "workspace_runtime_v7_registration_projection_omission"
SUPERSEDED_ROOT_RELATIVE = (
    "experiments/midogpp/stages/90_oracles_and_diagnostics/contracts/"
    "harp_router_v7/superseded_activations"
)
...
class HarpV7ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV7ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV7ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

"""Aggregate-only scientific, leakage, and runtime reports for P-DCAPS v4."""
...
FINAL_REPORT_SCHEMAS = {
    "reports/diagnostic_summary.json": "pdcaps_v4_diagnostic_summary_v1",
    "reports/label_capability_report.json": (
        "pdcaps_v4_label_capability_report_v1"
    ),
    "reports/leakage_report.json": "pdcaps_v4_leakage_report_v1",
    "reports/publication_decision.json": "pdcaps_v4_publication_decision_v1",
    "reports/runtime_summary.json": "pdcaps_v4_runtime_summary_v1",
}
...
def diagnostic_summary_payload(
    ...
    base = {
        "schema_version": "pdcaps_v4_diagnostic_summary_v1",
...
def label_capability_report_payload(
    ...
    base = {
        "schema_version": "pdcaps_v4_label_capability_report_v1",
...
def leakage_report_payload(
    *,
    ...
    source_tree = require_sha256(
        ...
        "v4 leakage source tree",
    )
    base = {
        "schema_version": "pdcaps_v4_leakage_report_v1",
        "status": "PASS",
...
def publication_decision_payload(
    ...
    base = {
        "schema_version": "pdcaps_v4_publication_decision_v1",
        "terminal_result_hash": result.result_hash,
        "publication_status": PUBLICATION_STATUS,
        "terminal_decision": TERMINAL_DECISION,
        "bounded_interpretation": (
...
def runtime_summary_payload(
    *,
    ...
    base = {
        "schema_version": "pdcaps_v4_runtime_summary_v1",
...
def validation_report_payload(
    ...
    base = {
        "schema_version": "pdcaps_v4_validation_report_v1",
        "status": "PASS",
...
def validate_final_report_payloads(
    ...
    *,
    ...
    result_hash = require_sha256(
        terminal_result_hash, "v4 terminal report result"
    )
    ...
    for member in FINAL_REPORT_MEMBERS:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 final report hash drifted.")
    ...
    if (
        ...
        is not False
        or leakage.get("prior_router_state_used") is not False
        ...
        raise ProtocolError("P-DCAPS v4 terminal-only report contract drifted.")
    return hashes

"""Main-process preterminal route construction for authorized P-DCAPS v4.
...
from ..fixed_bank_p_anchored_route_scoped_donor_crossfit_action_policy_surface_router.endpoint_runtime import (
...
class ZeroDonorPriorPolicy:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 zero donor-prior policy drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "pdcaps_v4_zero_donor_prior_policy_v1",
...
class PosteriorFitRecord:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 posterior fit record drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "pdcaps_v4_posterior_fit_record_v1",
                    "control_id": control,
...
class RouteScienceBinding:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 route science binding drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "pdcaps_v4_route_science_binding_v1",
                    "route_key": route.to_payload(),
...
class RouteRuntimeResult:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 route runtime inventory drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "pdcaps_v4_route_runtime_result_v1",
    ...
    def sample_order(self, center: str) -> tuple[str, ...]:
        try:
            ...
            raise ProtocolError("P-DCAPS v4 center sample order is absent.") from exc
...
class PseudoResponseRuntime:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 pseudo response runtime drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "pdcaps_v4_pseudo_response_runtime_v1",
    ...
    def responses(self, control_id: str) -> tuple[ActionResponse, ...]:
        try:
            ...
            raise ProtocolError("P-DCAPS v4 posterior-control responses are absent.") from exc
...
def build_route_runtime(
    *,
    ...
    if not isinstance(physical_surface, PhysicalSurface) or not isinstance(
        ...
        raise ProtocolError("P-DCAPS v4 route runtime requires typed inputs.")
    ...
    if (
        ...
        raise ProtocolError("P-DCAPS v4 route runtime lifecycle drifted.")
...
def open_all_pseudo_responses(
    ...
    if (
        ...
        raise ProtocolError("P-DCAPS v4 pseudo response lifecycle drifted.")
    ...
    for plan in route_runtime.route_plans.plans:
        ...
        if tuple(control for control, _responses in rows) != POSTERIOR_CONTROL_IDS:
            raise ProtocolError("P-DCAPS v4 pseudo response control drifted.")
        for control, responses in rows:

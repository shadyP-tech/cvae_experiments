"""Label-free DTOs and executable-source contracts for P-DCAPS v4."""
...
from .source_seal import (
    ...
    V4_EXECUTION_SOURCE_ROOT_ROLE as SOURCE_ROOT_ROLE,
    V4_EXECUTION_SOURCE_TREE_SCHEMA as SOURCE_TREE_SCHEMA,
    build_v4_execution_source_snapshot_members as build_source_snapshot_members,
    build_v4_execution_source_snapshot_payload as build_source_snapshot_payload,
    source_snapshot_identity,
    validate_source_snapshot,
    v4_execution_source_root as package_source_root,
)
...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("P-DCAPS v4 test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 label-free frame drifted.")
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "pdcaps_v4_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 embedding identity drifted.")

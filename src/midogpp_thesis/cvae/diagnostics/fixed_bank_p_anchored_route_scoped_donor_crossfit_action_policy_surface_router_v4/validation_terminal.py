...
def validate_terminal_row_inventory(
    *,
    ...
    if (
        ...
        raise ProtocolError("P-DCAPS v4 terminal method or case inventory drifted.")
    ...
    if observed_center_keys != expected_center_keys:
        raise ProtocolError("P-DCAPS v4 terminal center rectangle drifted.")
    center_by_key = {
    ...
    if observed_case_keys != expected_case_keys:
        raise ProtocolError("P-DCAPS v4 terminal case rectangle drifted.")
    ...
    for row in cases:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 terminal case semantics drifted.")
    ...
    for row in centers:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 terminal center semantics drifted.")
    ...
    for method in METHOD_MENU:
        for center in CENTERS:
            ...
            if (
                ...
                raise ProtocolError(
                    "P-DCAPS v4 terminal reference semantics drifted."
                )
    ...
    for row in methods:
        ...
        if (
            ...
            raise ProtocolError("P-DCAPS v4 terminal method semantics drifted.")
    ...
    if reference_sample_count != CANONICAL_ROW_COUNT or any(
        ...
        raise ProtocolError("P-DCAPS v4 terminal row coverage drifted.")
    return {
...
def _nonnegative_int(
    ...
    if (
        ...
        raise ProtocolError("P-DCAPS v4 terminal integer semantics drifted.")
    return value
...
def _finite_float(row: Mapping[str, object], key: str) -> float:
    ...
    if isinstance(value, bool) or not isinstance(value, (int, float)):
        raise ProtocolError("P-DCAPS v4 terminal metric semantics drifted.")
    number = float(value)

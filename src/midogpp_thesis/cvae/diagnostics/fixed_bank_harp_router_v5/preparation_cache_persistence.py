"""Persistence and independent validation of the HARP v5 label-free cache."""
...
def independently_validate_label_blind_barrier(
    ...
    *,
    ...
    if identity.cache_identity != V5_CACHE_IDENTITY:
        raise ProtocolError("HARP v5 preparation cache identity drifted.")

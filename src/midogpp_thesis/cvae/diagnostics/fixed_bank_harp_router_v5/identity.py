"""Immutable identity and claim boundary for the HARP v5 router."""
...
EXPERIMENT_ID = "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v5"
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_harp_router_v5"
OUTPUT_ARTIFACT_ID = "midogpp_output_uniform_b_v2_consumed_test_fixed_bank_harp_router_v5"
PUBLICATION_STATUS = "POST_HOC_CONSUMED_TEST_SENSITIVITY"
TERMINAL_DECISION = "TERMINAL_DIAGNOSTIC_ONLY_DO_NOT_PROMOTE"
CLAIM_SCOPE = "diagnostic_only"
EXECUTION_REVISION = (
    "v5_compatibility_conditioned_directional_opportunity_"
    "pairwise_risk_soft_topk"
)
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_harp_v5_compatibility_conditioned_"
...
def authorization_input_binding_payload(
    *,
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_authorized_input_binding_v5",
...
def claim_boundary_payload(*, execution_authorized: bool) -> dict[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_claim_boundary_v5",
        "experiment_id": EXPERIMENT_ID,

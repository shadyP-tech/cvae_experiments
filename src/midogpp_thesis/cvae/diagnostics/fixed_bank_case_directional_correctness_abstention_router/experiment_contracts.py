"""Frozen workspace identities for the case-directional abstention diagnostic."""
...
CLAIM_ROLE = (
    "posthoc_fixed_bank_whole_case_loo_case_directional_"
    "correctness_abstention_diagnostic"
)
ROUTING_STATUS = TERMINAL_DECISION
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_fixed_bank_case_directional_"
    "correctness_abstention_router_v1"
)
...
TEST_CACHE_ARTIFACT_ID = (
    "midogpp_stage90_fixed_bank_case_directional_correctness_"
    "abstention_router_test_cache_v1"
)
TEST_MANIFEST_ARTIFACT_ID = (
    "midogpp_stage90_fixed_bank_case_directional_correctness_"
    "abstention_router_test_manifest_v1"
)
TEST_CONSUMPTION_LEDGER_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_fixed_bank_"
    "case_directional_correctness_abstention_router_parent_v1"
)
LEDGER_AMENDMENT_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_fixed_bank_"
    "case_directional_correctness_abstention_router_amendment_v1"
)
LEDGER_AMENDMENT_FILENAME = (
    "uniform_b_v2_consumed_test_fixed_bank_case_directional_"
    "correctness_abstention_router_ledger_amendment_v1.json"
)
INPUT_ARTIFACT_IDS = (
    EXPERT_BANK_ARTIFACT_ID,
...
# A complete denial list: no earlier terminal diagnostic is an input or parent.
...
SCRATCH_ROOT = (
    "/data/local/fixed_bank_case_directional_correctness_"
...
if tuple(EXPECTED_CASE_COUNTS_BY_CENTER) != CENTERS:
    raise RuntimeError("Case-directional center order drifted at import time.")

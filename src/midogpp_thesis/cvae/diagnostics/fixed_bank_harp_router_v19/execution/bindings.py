"""Cross-artifact identity bindings for the HARP v19 phase machine."""
...
from ....runtime.harp_v19_execution.contracts import FrozenRouteReceipt, PrelabelRouteSet
from ....runtime.harp_v19_execution.stores import read_prelabel_routes
...
def validate_in_memory_route_bindings(
    ...
    *,
    ...
    if not isinstance(routes, PrelabelRouteSet):
        raise ProtocolError("HARP v19 routing returned an untyped route set.")
    if (
        ...
        raise ProtocolError("HARP v19 in-memory route cross-binding drifted.")
...
def reconstruct_frozen_routes_for_evaluation(
    ...
    *,
    ...
    if (
        frozen.get("schema_version") != "midogpp_harp_v19_frozen_route_seal_v1"
        ...
        raise ProtocolError("HARP v19 frozen route identity binding drifted.")
    ...
    if (
        ...
        raise ProtocolError("HARP v19 disk-reconstructed frozen routes drifted.")

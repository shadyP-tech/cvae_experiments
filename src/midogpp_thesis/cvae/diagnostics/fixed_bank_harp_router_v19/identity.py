"""Immutable identity and claim boundary for the isolated HARP v19 router."""
...
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_harp_router_v19"
OUTPUT_ARTIFACT_ID = "midogpp_output_uniform_b_v2_consumed_test_fixed_bank_harp_router_v19"
PUBLICATION_STATUS = "POST_HOC_CONSUMED_TEST_SENSITIVITY"
TERMINAL_DECISION = "TERMINAL_DIAGNOSTIC_ONLY_DO_NOT_PROMOTE"
CLAIM_SCOPE = "diagnostic_only"
EXECUTION_REVISION = "v19_known_center_safe_benefit_damage_complete_winner_gate_nested_crossfit"
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_harp_v19_"
...
def authorization_input_binding_payload(
    *,
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_authorized_input_binding_v19",
...
def claim_boundary_payload(*, execution_authorized: bool) -> dict[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_claim_boundary_v19",
        "experiment_id": EXPERIMENT_ID,

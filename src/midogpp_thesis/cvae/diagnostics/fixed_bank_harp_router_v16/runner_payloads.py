"""Deterministic durable manifests for the HARP v16 phase coordinator."""
...
def build_surface_seal_indexes(
    ...
    support = seal(
        {
            "schema_version": "midogpp_harp_v16_target_support_menu_seal_index_v1",
            **common,
    ...
    target = seal(
        {
            "schema_version": "midogpp_harp_v16_target_evaluation_menu_seal_index_v1",
            **common,
    ...
    attestations = seal(
        {
            "schema_version": "midogpp_harp_v16_bank_independence_attestation_index_v1",
            **common,
            "members": [
                {
                    "outer_target_id": row.outer_target_id,
...
def build_model_lock(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_model_lock_v1",
...
def build_policy_admission_seal(
    *, config_hash: str, fitted: object
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_support_policy_admission_seal_v1",
            "config_hash": config_hash,
            "model_hash": fitted.manifest["model_hash"],
            "policy_hash": fitted.manifest["policy_hash"],
...
def build_target_action_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_target_action_seal_v1",
...
def build_prelabel_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_prelabel_route_bundle_v1",
...
def build_validation_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_fresh_validation_bundle_v1",
            "config_hash": config_hash,
            "expected_center_ids": list(centers),
...
def build_frozen_route_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v16_frozen_route_seal_v1",
...
def build_run_state(
    *,
    ...
    return {
        "schema_version": "midogpp_harp_v16_run_state_v1",

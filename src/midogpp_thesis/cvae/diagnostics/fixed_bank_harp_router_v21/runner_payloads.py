"""Deterministic durable manifests for the HARP v21 phase coordinator."""
...
def build_surface_seal_indexes(
    ...
    if (
        ...
        raise ProtocolError("HARP v21 seal indexes require exact center coverage.")
    common = {
    ...
    source_train = seal(
        {
            "schema_version": "midogpp_harp_v21_source_train_menu_seal_index_v1",
            **common,
            "role": "source_train",
            "members": [
                {
    ...
    target = seal(
        {
            "schema_version": "midogpp_harp_v21_target_evaluation_menu_seal_index_v1",
            **common,
            "role": "target",
            "members": [
                {
    ...
    attestations = seal(
        {
            "schema_version": "midogpp_harp_v21_bank_independence_attestation_index_v1",
            **common,
            "members": [
                {
                    "center_id": _center_id(row),
...
def build_model_lock(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_model_lock_v1",
...
def build_policy_admission_seal(
    *, config_hash: str, fitted: object
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_source_policy_admission_seal_v1",
            "config_hash": config_hash,
            "model_hash": fitted.manifest["model_hash"],
            "policy_hash": fitted.manifest["policy_hash"],
...
def build_target_action_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_target_action_seal_v1",
...
def build_prelabel_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_prelabel_route_bundle_v1",
...
def build_validation_bundle(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_fresh_validation_bundle_v1",
            "config_hash": config_hash,
            "expected_center_ids": list(centers),
...
def build_frozen_route_seal(
    *,
    ...
    return seal(
        {
            "schema_version": "midogpp_harp_v21_frozen_route_seal_v1",
...
def build_run_state(
    *,
    ...
    return {
        "schema_version": "midogpp_harp_v21_run_state_v1",

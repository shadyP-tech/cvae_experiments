"""Cross-artifact identity bindings for the HARP v21 phase machine."""
...
from ....runtime.harp_v21_execution.contracts import FrozenRouteReceipt, PrelabelRouteSet
from ....runtime.harp_v21_execution.stores import read_prelabel_routes
...
def validate_in_memory_route_bindings(
    ...
    *,
    ...
    if not isinstance(routes, PrelabelRouteSet):
        raise ProtocolError("HARP v21 routing returned an untyped route set.")
    if (
        ...
        raise ProtocolError("HARP v21 in-memory route cross-binding drifted.")
...
def reconstruct_frozen_routes_for_evaluation(
    ...
    *,
    ...
    if (
        frozen.get("schema_version") != "midogpp_harp_v21_frozen_route_seal_v1"
        ...
        raise ProtocolError("HARP v21 frozen route identity binding drifted.")
    ...
    if (
        ...
        raise ProtocolError("HARP v21 disk-reconstructed frozen routes drifted.")

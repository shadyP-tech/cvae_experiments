"""Leakage, routing, and terminal report construction for HARP v21."""
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v21_leakage_report_v1",
        ...
        "source_labels_update_pooled_v21_router_only": True,
        ...
        "v1_through_v20_policy_rank_output_cache_or_authority_used": False,
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v21_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v21_validation_report_v1",
        "status": "PASS",

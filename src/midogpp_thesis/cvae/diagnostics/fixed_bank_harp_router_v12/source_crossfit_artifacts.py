"""Deterministic artifact payloads for the HARP v12 source crossfit.
...
def persist_and_reconstruct_source_crossfit_surface(
    ...
    if (
        ...
        raise ProtocolError(
            "HARP v12 durable source-crossfit reconstruction changed identity."
        )
...
def build_source_crossfit_effective_artifact(
    ...
    body = {
        "schema_version": "midogpp_harp_v12_source_crossfit_effective_menu_store_v1",
...
def build_source_prelabel_prediction_artifact(
    ...
    body = {
        "schema_version": "midogpp_harp_v12_source_prelabel_q_prediction_store_v1",
...
def source_fold_capability_seal_payload(
    ...
    body = {
        "schema_version": "midogpp_harp_v12_source_fold_label_capability_seals_v1",
        "source_surface_receipt_hash": fold_seal_set.source_surface_receipt_hash,
        "source_surface_hash": fold_seal_set.source_surface_hash,
        "effective_adapter_hash": fold_seal_set.effective_adapter_hash,
        "folds": [
...
def source_prelabel_q_prediction_seal_payload(
    ...
    *,
    ...
    body = {
        "schema_version": "midogpp_harp_v12_source_prelabel_q_prediction_seal_v1",
        "source_surface_receipt_hash": fold_seal_set.source_surface_receipt_hash,
        "source_surface_hash": fold_seal_set.source_surface_hash,
        "effective_adapter_hash": fold_seal_set.effective_adapter_hash,
        "fold_seal_set_hash": fold_seal_set.seal_set_hash,
...
def build_development_artifact(
    ...
    *,
    ...
    body = {
        "schema_version": "midogpp_harp_v12_source_train_crossfit_development_surface_v1",

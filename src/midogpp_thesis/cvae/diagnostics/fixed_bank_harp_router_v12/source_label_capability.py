"""Typed source-label capabilities for HARP v12 nested cross-fitting.
...
class FoldSourceLabelCapability:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v12 fold source-label capability is malformed.")
        ...
        prediction_surface_hash = canonical_hash(
            {
                "schema_version": "midogpp_harp_v12_q_prediction_surface_seal_v1",
                "outer_target_id": h,
                "heldout_center_id": q,
        ...
        fitting_surface_hash = canonical_hash(
            {
                "schema_version": "midogpp_harp_v12_q_fitting_surface_seal_v1",
                "outer_target_id": h,
                "heldout_center_id": q,
                "source_surface_receipt_hash": receipt.receipt_hash,
                "source_surface_hash": receipt.surface_hash,
        ...
        body = {
            "schema_version": "midogpp_harp_v12_fold_source_label_capability_v1",
            "outer_target_id": h,
            "heldout_center_id": q,
            "allowed_center_ids": list(allowed),
    ...
    def authorize(self, allowed_center_ids: Sequence[str]) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v12 fold source-label capability is cross-scoped.")
...
class AggregateSourceLabelCapability:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v12 aggregate source-label capability is malformed.")
        body = {
            "schema_version": "midogpp_harp_v12_aggregate_source_label_capability_v1",
            "source_surface_receipt_hash": receipt.receipt_hash,
            "source_surface_hash": receipt.surface_hash,
    ...
    def authorize(self, allowed_center_ids: Sequence[str]) -> None:
        ...
        if (
            ...
            raise ProtocolError("HARP v12 aggregate source-label capability is cross-scoped.")
...
def issue_fold_source_label_capability(
    *,
    ...
    if (
        ...
        raise ProtocolError("HARP v12 effective/physical crossfit surfaces are unbound.")
    ...
    if (
        ...
        raise ProtocolError("HARP v12 fold effective inventory crossed H/q.")
...
def _fresh_receipt(receipt: object) -> SourceCrossfitSurfaceReceipt:
    if not isinstance(receipt, SourceCrossfitSurfaceReceipt):
        raise ProtocolError("HARP v12 source labels require a typed physical receipt.")

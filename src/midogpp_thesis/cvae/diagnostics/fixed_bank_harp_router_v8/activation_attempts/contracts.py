"""Typed identities for archived HARP v8 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V8_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v8"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v8"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v8/superseded_activations"
)
...
class HarpV8ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV8ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV8ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

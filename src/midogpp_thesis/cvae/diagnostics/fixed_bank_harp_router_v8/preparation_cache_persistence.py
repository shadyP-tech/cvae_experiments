"""Persistence and independent validation of the HARP v8 label-free cache."""
...
def independently_validate_label_blind_barrier(
    ...
    *,
    ...
    if identity.cache_identity != V8_CACHE_IDENTITY:
        raise ProtocolError("HARP v8 preparation cache identity drifted.")

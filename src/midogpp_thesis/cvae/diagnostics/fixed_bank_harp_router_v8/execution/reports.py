"""Leakage, routing, and terminal report construction for HARP v8."""
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v8_leakage_report_v1",
        ...
        "nested_source_center_lodo_hyperparameter_selection": True,
        ...
        "action_specific_signed_gain_harm_and_proper_loss_heads": True,
        "source_center_group_residual_action_certificates": True,
        "safe_action_set_then_relative_rank": True,
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v8_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v8_validation_report_v1",
        "status": "PASS",

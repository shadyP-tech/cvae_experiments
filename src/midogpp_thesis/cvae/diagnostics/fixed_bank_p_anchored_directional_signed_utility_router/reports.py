...
def protocol_manifest_payload(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pdsur_protocol_manifest_v1",
...
def leakage_report_payload(
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pdsur_leakage_report_v1",
        "status": "PASS",
        ...
        "complete_delete_one_donor_stability_used": True,
...
def publication_decision_payload(terminal: object) -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_pdsur_publication_decision_v1",
        ...
        "unconfirmed_thesis_specific_mechanism_hypothesis": (
            "P-anchored_directional_direct_signed_utility_with_outer-center-"
            "excluded_donors_residual_correction_branch-disjoint_selection_"
            "and_fixed_sign-preserving_probability_shrinkage"
        ),
...
def run_state_payload(
    *,
    ...
    return {
        "schema_version": "fixed_bank_pdsur_run_state_v1",
        "status": status,
        "phase": phase,
        "error": error,

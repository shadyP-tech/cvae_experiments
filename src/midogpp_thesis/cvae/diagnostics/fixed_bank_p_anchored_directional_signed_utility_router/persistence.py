"""Phase-local persistence for reconstructive, raw-label-free PDSUR artifacts."""
...
def persist_admission(
    ...
    *,
    ...
    action_payload = {
        "schema_version": "fixed_bank_pdsur_action_library_manifest_v1",
        "actions": [
...
def persist_physical_surface(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pdsur_physical_surface_seal_v1",
    ...
    persist_rows(
        ...
        rows,
        schema_version="fixed_bank_pdsur_probability_index_table_v1",
    )
...
def persist_preterminal(root: Path, preterminal: object) -> None:
    ...
    plan_manifest = {
        "schema_version": "fixed_bank_pdsur_outer_plan_manifest_v1",
    ...
    persist_rows(
        ...
        outer_rows,
        schema_version="fixed_bank_pdsur_outer_plan_table_v1",
    )
    descriptors = [
        row.to_payload()
    ...
    utility_predictions = [
        ...
        for row in preterminal.utility_predictions_by_policy[policy]
    ]
    compositions = [
        row.to_payload()
        for policy in COMPOSED_POLICY_IDS
    ...
    persist_rows(
        ...
        descriptors,
        schema_version="fixed_bank_pdsur_utility_descriptor_table_v1",
        allow_empty=True,
    )
    persist_rows(
        root / "tables/donor_utility_rows.json",
        donor_rows,
        schema_version="fixed_bank_pdsur_donor_utility_row_table_v1",
        allow_empty=True,
    )
    persist_rows(
        root / "tables/utility_models.json",
        models,
        schema_version="fixed_bank_pdsur_utility_model_table_v1",
    )
    persist_rows(
        root / "tables/utility_predictions.json",
        utility_predictions,
        schema_version="fixed_bank_pdsur_utility_prediction_table_v1",
        allow_empty=True,
    )
    persist_rows(
        root / "tables/composed_predictions.json",
        compositions,
        schema_version="fixed_bank_pdsur_composed_prediction_table_v1",
    )
    persist_rows(
        root / "tables/route_decisions.json",
        route_decisions,
        schema_version="fixed_bank_pdsur_route_decision_table_v1",
    )
    persist_json(
        root / "manifests/policy_menu.json",
        {
            "schema_version": "fixed_bank_pdsur_policy_menu_manifest_v1",
...
def persist_terminal(
    ...
    *,
    ...
    persist_rows(
        ...
        schema_version="fixed_bank_pdsur_method_metric_table_v1",
    )
    persist_rows(
        root / "tables/terminal_center_contrasts.json",
        terminal.center_contrasts,
        schema_version="fixed_bank_pdsur_center_contrast_table_v1",
    )
    persist_rows(
        root / "tables/terminal_case_oracles.json",
        terminal.case_oracle_rows,
        schema_version="fixed_bank_pdsur_case_oracle_table_v1",
    )
    persist_rows(
        root / "tables/utility_information_rows.json",
        terminal.utility_information_rows,
        schema_version="fixed_bank_pdsur_utility_information_table_v1",
        allow_empty=True,
    )
    persist_rows(
        root / "tables/utility_information_centers.json",
        terminal.utility_information_center_rows,
        schema_version="fixed_bank_pdsur_utility_information_center_table_v1",
    )

"""Thin, phase-ordered runner for the terminal PDSUR diagnostic."""
...
def run_p_anchored_directional_signed_utility_router(
    config: object,
    *,
    ...
    with exclusive_run_lock(root):
        ...
        try:
            ...
            phase = "OUTER_LOO_ENDPOINTS_AND_DONOR_SIGNED_UTILITY_ROUTING"
            write_state(root, status="RUNNING", phase=phase)
            _observe(phase_observer, phase)
...
run_pdsur = run_p_anchored_directional_signed_utility_router


__all__ = ("run_p_anchored_directional_signed_utility_router", "run_pdsur")

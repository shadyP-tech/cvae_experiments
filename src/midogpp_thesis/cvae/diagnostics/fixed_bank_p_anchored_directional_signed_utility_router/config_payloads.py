"""Canonical executable config sections for PDSUR."""
...
def canonical_action_library_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_pdsur_action_library_v1",
...
def canonical_policy_menu_payload() -> dict[str, object]:
    return {
        ...
        "utility_actions_selected_from_terminal_labels": False,
        "direct_signed_utility_responses": [
...
def canonical_evaluation_payload() -> dict[str, object]:
    return {
        ...
        "utility_information_diagnostics": [
            "signed_BACC_utility_Spearman",
            "signed_response_MAE",
            "response_sign_agreement",
            "held_donor_residual_dispersion",
            "delete_donor_sign_consensus",
            "blocked_feature_control",
        ],
        "oracle_diagnostics": [
        ...
        "utility_rows_are_not_independent_inference_units": True,
        "blocked_permutation_unit": "complete_case_rows",
...
def canonical_runtime_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_pdsur_workstation_runtime_v1",
...
def canonical_claim_boundary_payload() -> dict[str, object]:
    return {
        ...
        "bounded_interpretation": "outer_center_excluded_directional_signed_utility_sensitivity_only",
        "consumed_test_data": True,
        "method_development_is_posthoc": True,
        "route_features_and_signed_utility_rule_predeclared_for_this_run": True,

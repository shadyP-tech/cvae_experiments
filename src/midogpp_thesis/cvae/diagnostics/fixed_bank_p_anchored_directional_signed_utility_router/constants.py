"""Frozen constants for the P-anchored directional signed-utility router.
...
EXPERIMENT_ID = (
    ...
    "p_anchored_directional_signed_utility_router.v1"
)
EXPERIMENT_NAME = (
    "uniform_b_v2_consumed_test_fixed_bank_"
    "p_anchored_directional_signed_utility_router_v1"
)
OUTPUT_ARTIFACT_ID = (
...
CLAIM_ROLE = (
    "posthoc_fixed_bank_p_anchored_directional_signed_utility_router_"
    "diagnostic"
)
...
MODEL_BASED_METHOD_ID = "PDSUR_STABLE"
BACC_ONLY_METHOD_ID = "PDSUR_BACC_ONLY"
FULL_ONLY_METHOD_ID = "PDSUR_FULL_ONLY"
PERMUTATION_METHOD_ID = "PDSUR_BLOCKED_PERMUTATION"
COMPOSED_POLICY_IDS = (
...
# primary and blocked-control multivariate response surfaces x
# (one full + eight delete-donor fits) x nine outer targets.
EXPECTED_UTILITY_MODEL_FIT_COUNT = (
    2 * len(CENTERS) * len(CENTERS)
)
...
SCRATCH_ROOT = "/data/local/fixed_bank_p_anchored_directional_signed_utility_router_v1"

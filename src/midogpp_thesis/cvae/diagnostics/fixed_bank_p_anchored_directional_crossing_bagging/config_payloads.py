"""Canonical executable config sections for PDCB."""
...
def canonical_action_library_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_pdcb_action_library_v1",
...
def canonical_policy_menu_payload() -> dict[str, object]:
    return {
        ...
        "crossing_weights_selected_from_terminal_utility": False,
        "crossing_helpfulness_is_compatibility_proxy_not_expected_gain": True,
    }
...
def canonical_evaluation_payload() -> dict[str, object]:
    return {
        ...
        "crossing_rows_are_not_independent_inference_units": True,
        "blocked_permutation_unit": "complete_equal_size_case_blocks",
...
def canonical_runtime_payload() -> dict[str, object]:
    return {
        "schema_version": "fixed_bank_pdcb_workstation_runtime_v1",
        ...
        "expected_crossing_model_fit_count": EXPECTED_CROSSING_MODEL_FIT_COUNT,
...
def canonical_claim_boundary_payload() -> dict[str, object]:
    return {
        ...
        "bounded_interpretation": "outer_center_excluded_donor_crossing_bagging_sensitivity_only",
        "consumed_test_data": True,
        "method_development_is_posthoc": True,
        "route_features_and_bagging_rule_predeclared_for_this_run": True,

...
SCHEMA = "fixed_bank_pdcb_workstation_preflight_v1"
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        != EXPECTED_OUTER_ENDPOINT_MODEL_FIT_COUNT
        or payload.get("expected_crossing_model_fit_count")
        != EXPECTED_CROSSING_MODEL_FIT_COUNT
        ...
        raise ProtocolError("PDCB persisted workstation preflight drifted.")
    return payload

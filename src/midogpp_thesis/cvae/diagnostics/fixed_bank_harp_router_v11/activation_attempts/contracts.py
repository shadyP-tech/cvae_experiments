"""Typed identities for archived HARP v11 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V11_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v11"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v11"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v11/superseded_activations"
)
...
class HarpV11ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV11ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV11ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

...
PREPARATION_RECEIPT = Path("manifests/harp_v3_consumed_test_preparation_receipt.json")
LABEL_FREE_BARRIER = Path("manifests/harp_v3_label_free_partition_barrier.json")
LABEL_FREE_CONTENT_INDEX = Path("manifests/harp_v3_label_free_content_index.json")
CASE_PARTITION = Path("manifests/harp_v3_case_partition.json")
_METADATA_FIELDS = {
    "evaluation_row_id",
    "contract_row_index",
    "case_id",
...
V3_PREPARATION_IDENTITY = HarpPreparationIdentity(
    experiment_id=EXPERIMENT_ID,
    publication_status=PUBLICATION_STATUS,
    terminal_decision=TERMINAL_DECISION,
    prepared_inputs_schema="midogpp_harp_consumed_test_prepared_inputs_v3",
    partition_schema="midogpp_harp_consumed_test_case_partition_v3",
    preparation_receipt_schema="midogpp_harp_consumed_test_preparation_receipt_v3",
    label_free_barrier_schema="midogpp_harp_consumed_test_label_free_barrier_v3",
    cache_identity=V3_CACHE_IDENTITY,
)
...
class HarpV3PreparedInputs:
    ...
    def to_payload(self) -> dict[str, object]:
        ...
        return {
            "schema_version": "midogpp_harp_consumed_test_prepared_inputs_v3",
...
def prepare_harp_consumed_test_inputs_v3(
    *,
    canonical_cache_root: str | Path,
    canonical_manifest_path: str | Path,
    parent_ledger_path: str | Path,
...
def _write_cache_rows(
    ...
    *,
    row_schema: str = V3_CACHE_IDENTITY.row_schema,
) -> None:
    buffer = io.StringIO(newline="")
    writer = csv.writer(buffer, lineterminator="\n")
    writer.writerow(
...
def _write_content_index(
    ...
    *,
    content_schema: str = V3_CACHE_IDENTITY.content_schema,
) -> None:

"""Cross-artifact identity bindings for the HARP v20 phase machine."""
...
from ....runtime.harp_v20_execution.contracts import FrozenRouteReceipt, PrelabelRouteSet
from ....runtime.harp_v20_execution.stores import read_prelabel_routes
...
def validate_in_memory_route_bindings(
    ...
    *,
    ...
    if not isinstance(routes, PrelabelRouteSet):
        raise ProtocolError("HARP v20 routing returned an untyped route set.")
    if (
        ...
        raise ProtocolError("HARP v20 in-memory route cross-binding drifted.")
...
def reconstruct_frozen_routes_for_evaluation(
    ...
    *,
    ...
    if (
        frozen.get("schema_version") != "midogpp_harp_v20_frozen_route_seal_v1"
        ...
        raise ProtocolError("HARP v20 frozen route identity binding drifted.")
    ...
    if (
        ...
        raise ProtocolError("HARP v20 disk-reconstructed frozen routes drifted.")

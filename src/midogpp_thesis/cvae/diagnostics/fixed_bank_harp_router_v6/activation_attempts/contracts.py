"""Typed identities for archived HARP v6 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V6_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v6"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v6"
)
SUPERSESSION_REASON = "workspace_runtime_v6_registration_projection_omission"
SUPERSEDED_ROOT_RELATIVE = (
    "experiments/midogpp/stages/90_oracles_and_diagnostics/contracts/"
    "harp_router_v6/superseded_activations"
)
...
class HarpV6ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV6ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV6ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

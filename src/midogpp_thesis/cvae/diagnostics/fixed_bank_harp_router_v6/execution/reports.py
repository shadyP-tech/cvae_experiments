"""Leakage, routing, and terminal report construction for HARP v6."""
...
from ....runtime.harp_v6_execution.contracts import (
    PrelabelRouteSet,
    TerminalEvaluation,
)
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v6_leakage_report_v1",
        ...
        "exact_B_opposite_branch_and_fallback": True,
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v6_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v6_validation_report_v1",
        "status": "PASS",

"""Typed identities for archived HARP v17 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V17_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v17"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v17"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v17/superseded_activations"
)
...
ACTIVE_SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V17_ACTIVE_UNCONSUMED_PRELEASE_ACTIVATION_FOR_REPLANNING"
)
ACTIVE_SUPERSESSION_PLAN_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_plan_v17"
)
ACTIVE_SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_receipt_v17"
)
...
SUPERSEDED_ACTIVE_ROOT_RELATIVE = (
    "experiments/midogpp/stages/90_oracles_and_diagnostics/contracts/"
    "harp_router_v17/superseded_active_activations"
)
...
RETIREMENT_FENCE_SCHEMA = "midogpp_harp_v17_active_supersession_retirement_fence_v1"
ACTIVE_SUPERSESSION_RECEIPT = "active_supersession_receipt.json"


@dataclass(frozen=True, slots=True)
class HarpV17ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV17ActivationSupersessionReceipt:
...
@dataclass(frozen=True, slots=True)
class HarpV17ActiveActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV17ActiveActivationSupersessionReceipt:
    payload: Mapping[str, object]
...
def receipt_payload(plan: HarpV17ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

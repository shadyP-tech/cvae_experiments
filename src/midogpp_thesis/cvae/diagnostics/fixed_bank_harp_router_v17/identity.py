"""Immutable identity and claim boundary for the isolated HARP v17 router."""
...
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_harp_router_v17"
OUTPUT_ARTIFACT_ID = "midogpp_output_uniform_b_v2_consumed_test_fixed_bank_harp_router_v17"
PUBLICATION_STATUS = "POST_HOC_CONSUMED_TEST_SENSITIVITY"
TERMINAL_DECISION = "TERMINAL_DIAGNOSTIC_ONLY_DO_NOT_PROMOTE"
CLAIM_SCOPE = "diagnostic_only"
EXECUTION_REVISION = (
    "v17_source_train_known_center_full_test_pooled_pairwise_selected_policy_"
    "nested_center_stratified_crossfit_soft_topk"
)
AUTHORIZATION_SCOPE = (
    "one_terminal_consumed_test_harp_v17_"
    "source_train_pooled_pairwise_selected_policy_router_diagnostic"
)
...
def authorization_input_binding_payload(
    *,
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_authorized_input_binding_v17",
...
def claim_boundary_payload(*, execution_authorized: bool) -> dict[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_claim_boundary_v17",
        "experiment_id": EXPERIMENT_ID,

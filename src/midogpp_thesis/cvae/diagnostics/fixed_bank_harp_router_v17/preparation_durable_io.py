"""Durable, deterministic file publication helpers for HARP v17 preparation."""
...
from .preparation_contracts import V17_PREPARATION_IDENTITY
...
def write_cache_rows(
    ...
    *,
    row_schema: str = V17_PREPARATION_IDENTITY.cache_identity.row_schema,
) -> None:
...
def write_content_index(
    ...
    *,
    content_schema: str = V17_PREPARATION_IDENTITY.cache_identity.content_schema,
) -> None:

"""Leakage, routing, and terminal report construction for HARP v4."""
...
from ....runtime.harp_v4_execution.contracts import (
    PrelabelRouteSet,
    TerminalEvaluation,
)
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v4_leakage_report_v1",
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v4_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v4_validation_report_v1",
        "status": "PASS",

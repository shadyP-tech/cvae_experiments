...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("PUMR test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR label-free frame drifted.")
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "fixed_bank_pumr_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("PUMR embedding identity drifted.")

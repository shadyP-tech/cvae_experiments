...
def protocol_manifest_payload(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pumr_protocol_manifest_v1",
...
def leakage_report_payload(
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_pumr_leakage_report_v1",
        "status": "PASS",
        ...
        "nested_leave_one_donor_margin_replay_used": True,
...
def publication_decision_payload(terminal: object) -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_pumr_publication_decision_v1",
        ...
        "unconfirmed_thesis_specific_mechanism_hypothesis": (
            ...
            "with_outer-center-excluded_nested-donor_margin_calibration_"
            "branch-disjoint_selection_and_fixed_sign-preserving_shrinkage"
        ),
...
def run_state_payload(
    *,
    ...
    return {
        "schema_version": "fixed_bank_pumr_run_state_v1",
        "status": status,
        "phase": phase,
        "error": error,

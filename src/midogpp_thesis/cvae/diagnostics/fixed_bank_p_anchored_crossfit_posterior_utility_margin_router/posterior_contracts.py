...
class PhysicalFingerprintSurface:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR physical fingerprint topology drifted.")
        require_sha256(self.source_surface_hash, "physical_source_surface_hash")
        values.setflags(write=False)
        payload = {
            "schema_version": "fixed_bank_pumr_physical_fingerprint_v1",
            "center": self.center,
    ...
    def positions(self, case_id: object) -> np.ndarray:
        ...
        if not len(positions):
            raise ProtocolError("PUMR fingerprint requested an absent case.")
        return positions

    def summary_payload(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pumr_physical_fingerprint_summary_v1",
            "center": self.center,
...
class SupportFoldPlan:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR support-fold plan drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pumr_support_fold_plan_v1",
...
class TargetLocalPosteriorModel:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR target-local posterior model drifted.")
        for digest, name in (
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pumr_target_local_posterior_model_v1",
            "target_center": self.target_center,
            "held_case_id": self.held_case_id,
            "fold_id": self.fold_id,
            "training_case_ids": list(self.training_case_ids),
...
class CasePosteriorPrediction:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR posterior prediction drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pumr_case_posterior_prediction_v1",
            "target_center": self.target_center,
...
class RoutePosteriorEnsemble:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PUMR route posterior ensemble drifted.")
        for digest in (
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pumr_route_posterior_ensemble_v1",
            "target_center": self.target_center,
            "held_case_id": self.held_case_id,
            "control_id": self.control_id,
...
def index_ensembles(
    ...
    if len(indexed) != len(rows):
        raise ProtocolError("PUMR posterior ensembles duplicate a route.")

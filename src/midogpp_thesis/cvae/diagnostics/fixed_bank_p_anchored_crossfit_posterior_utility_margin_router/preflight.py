...
SCHEMA = "fixed_bank_pumr_workstation_preflight_v1"
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        raise ProtocolError("PUMR persisted workstation preflight drifted.")
    return payload

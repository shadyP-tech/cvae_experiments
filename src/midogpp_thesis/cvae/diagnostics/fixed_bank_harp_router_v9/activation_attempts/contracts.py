"""Typed identities for archived HARP v9 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V9_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v9"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v9"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v9/superseded_activations"
)
...
class HarpV9ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV9ActivationSupersessionReceipt:
...
def receipt_payload(plan: HarpV9ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

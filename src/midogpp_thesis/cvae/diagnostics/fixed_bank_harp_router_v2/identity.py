"""Immutable identity and claim boundary for optimized HARP sensitivity v2."""
...
EXPERIMENT_ID = "midogpp.oracle.uniform_b_v2_consumed_test_fixed_bank_harp_router.v2"
EXPERIMENT_NAME = "uniform_b_v2_consumed_test_fixed_bank_harp_router_v2"
OUTPUT_ARTIFACT_ID = "midogpp_output_uniform_b_v2_consumed_test_fixed_bank_harp_router_v2"
PUBLICATION_STATUS = "POST_HOC_CONSUMED_TEST_SENSITIVITY"
TERMINAL_DECISION = "TERMINAL_DIAGNOSTIC_ONLY_DO_NOT_PROMOTE"
CLAIM_SCOPE = "diagnostic_only"
EXECUTION_REVISION = "v2_byte_equivalent_performance_optimization"
AUTHORIZATION_SCOPE = "one_terminal_consumed_test_fixed_bank_harp_router_v2_optimized_diagnostic"
...
def authorization_input_binding_payload(
    *,
    ...
    payload: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_authorized_input_binding_v2",
...
def claim_boundary_payload(*, execution_authorized: bool) -> dict[str, object]:
    payload: dict[str, object] = {
        "schema_version": "midogpp_harp_stage90_claim_boundary_v2",
        "experiment_id": EXPERIMENT_ID,

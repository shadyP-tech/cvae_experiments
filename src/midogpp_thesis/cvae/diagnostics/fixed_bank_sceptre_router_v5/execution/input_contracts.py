"""Immutable, label-free consumed-test DTOs for SCEPTRE v5."""
...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("SCEPTRE v5 test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v5 label-free frame drifted.")
        if self.canonical_coverage and (
            ...
            raise ProtocolError("SCEPTRE v5 canonical whole-case coverage drifted.")
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "sceptre_v5_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v5 embedding identity drifted.")

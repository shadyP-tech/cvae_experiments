"""Exact-eight executable inputs and immutable SCEPTRE v5 anchors."""
...
CANONICAL_OUTPUT_ROOT = (
    ...
    "uniform_b_v2_consumed_test_fixed_bank_sceptre_router/v5"
)
CANONICAL_SCRATCH_ROOT = "/data/local/fixed_bank_sceptre_router_v5"
...
SOURCE_INNER_ALIAS_ARTIFACT_ID = (
    "midogpp_stage90_sceptre_source_inner_candidate_utility_reuse_v5"
)
SOURCE_INNER_AMENDMENT_ARTIFACT_ID = (
    "midogpp_stage90_sceptre_source_inner_adaptive_reuse_amendment_v5"
)
TEST_CACHE_ARTIFACT_ID = "midogpp_stage90_sceptre_test_cache_v5"
TEST_MANIFEST_ARTIFACT_ID = "midogpp_stage90_sceptre_test_manifest_v5"
TEST_CONSUMPTION_LEDGER_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_parent_v5"
)
EXECUTION_AMENDMENT_ARTIFACT_ID = (
    "midogpp_uniform_b_test_consumption_ledger_sceptre_execution_amendment_v5"
)
SOURCE_INNER_ORIGINAL_ARTIFACT_ID = (
    "midogpp_output_uniform_b_v2_source_inner_candidate_utility_v1"
)

SOURCE_INNER_AMENDMENT_FILENAME = "source_inner_adaptive_reuse_amendment_v5.json"
EXECUTION_AMENDMENT_FILENAME = "sceptre_v5_execution_amendment.json"
...
AUTHORIZED_INPUT_ROLES = (
    ...
    "consumer_fenced_v5_source_inner_seven_member_alias",
    "v5_source_inner_complete_ranking_prior_amendment",
    "v5_label_free_consumed_test_cache_alias",
    "v5_role_scoped_consumed_test_manifest_alias",
    "exact_parent_test_consumption_ledger_alias",
    "v5_single_use_execution_amendment",
)
...
EXPECTED_SOURCE_INNER_AMENDMENT_SHA256 = (
    "b36d58926fc7159469b149e867c2037803317bc071e9e9a0489a901660743648"
)
...
FORBIDDEN_PREDECESSOR_FRAGMENTS = (
    ...
    "consumed_test_fixed_bank_sceptre_router/v1",
    "consumed_test_fixed_bank_sceptre_router/v2",
    "consumed_test_fixed_bank_sceptre_router/v3",
    "consumed_test_fixed_bank_sceptre_router/v4",
    "authorization_lease",
    "run_state.json",
    "/scratch/",
    "/checkpoints/",
...
FORBIDDEN_INPUT_FRAGMENTS = (
    ...
    "uniform_b_v2_consumed_test_fixed_bank_sceptre_router/v3",
    "uniform_b_v2_consumed_test_fixed_bank_sceptre_router/v4",
    "fixed_bank_sceptre_router_v1-scratch",
    "fixed_bank_sceptre_router_v2-scratch",
    "fixed_bank_sceptre_router_v3-scratch",
    "fixed_bank_sceptre_router_v4-scratch",
...
SOURCE_INNER_AMENDMENT_RELATIVE_PATH = (
    ...
    "sceptre_router_v5/source_inner_adaptive_reuse_amendment_v5.json"
)

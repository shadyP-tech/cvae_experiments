...
class PhysicalFingerprintSurface:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC physical fingerprint topology drifted.")
        require_sha256(self.source_surface_hash, "physical_source_surface_hash")
        values.setflags(write=False)
        payload = {
            "schema_version": "fixed_bank_pcsi_parc_physical_fingerprint_v1",
            "center": self.center,
    ...
    def positions(self, case_id: object) -> np.ndarray:
        ...
        if not len(positions):
            raise ProtocolError("PCSI-PARC fingerprint requested an absent case.")
        return positions

    def summary_payload(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_physical_fingerprint_summary_v1",
            "center": self.center,
...
class TargetLocalPosteriorModel:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC target-local posterior model drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_target_local_posterior_model_v1",
...
class TargetLocalPosteriorPrediction:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC target-local posterior prediction drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_target_local_posterior_prediction_v1",
            "target_center": self.target_center,
...
class InfluencePrediction:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("PCSI-PARC sample-influence prediction drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_sample_influence_prediction_v1",
...
def index_predictions(
    ...
    if len(indexed) != len(rows):
        raise ProtocolError("PCSI-PARC posterior predictions duplicate a route.")

"""Frozen, sibling-owned PCSI-PARC control specifications."""
...
class ControlSpec:
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_control_spec_v1",
...
def control_spec(policy_id: str) -> ControlSpec:
    try:
        ...
        raise ProtocolError("PCSI-PARC requested an unknown control.") from exc

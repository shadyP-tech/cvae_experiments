...
SCHEMA = "fixed_bank_pcsi_parc_workstation_preflight_v1"
...
def run_workstation_preflight(
    ...
    if (
        ...
        raise ProtocolError("PCSI-PARC recovery policy drifted.")
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        != EXPECTED_UTILITY_MODEL_FIT_COUNT
        or payload.get("expected_projected_PARC_utility_model_fit_count")
        != EXPECTED_PARC_MODEL_FIT_COUNT_PER_GEOMETRY
        or payload.get("expected_raw_full_action_PARC_utility_model_fit_count")
        != EXPECTED_PARC_MODEL_FIT_COUNT_PER_GEOMETRY
        or payload.get("expected_fresh_legacy_utility_model_fit_count")
        != EXPECTED_LEGACY_UTILITY_MODEL_FIT_COUNT
        ...
        is not False
        or payload.get("transport_authorization_valid") is not False
        ...
        raise ProtocolError("PCSI-PARC persisted workstation preflight drifted.")
    return payload

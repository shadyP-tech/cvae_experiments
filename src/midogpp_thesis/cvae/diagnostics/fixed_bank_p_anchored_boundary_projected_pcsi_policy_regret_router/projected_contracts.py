"""Typed contracts for projected/unprojected PCSI-PARC utility surfaces."""
...
class ProjectedUtilityDescriptor:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC projected descriptor identity drifted.")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_projected_descriptor_v1",
...
class ProjectedDonorUtilityRow:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC projected donor response drifted.")
    ...
    def response(self, response_id: str) -> float:
        if response_id not in UTILITY_RESPONSE_IDS:
            raise ProtocolError("PCSI-PARC requested an unknown response.")
        return float(getattr(self, response_id))

    def to_payload(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_projected_donor_row_v1",
            **self.__dict__,
            "feature_values": list(self.feature_values),
...
class ProjectedUtilityModel:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC projected model contract drifted.")
    ...
    def to_payload(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_projected_model_v1",
...
class ProjectedUtilityPrediction:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("PCSI-PARC projected prediction drifted.")
        require_sha256(self.descriptor_hash, "projected_descriptor_hash")
    ...
    def _unhashed(self) -> dict[str, object]:
        return {
            "schema_version": "fixed_bank_pcsi_parc_projected_prediction_v1",

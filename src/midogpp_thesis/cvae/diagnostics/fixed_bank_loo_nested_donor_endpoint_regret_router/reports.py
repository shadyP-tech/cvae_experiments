...
def protocol_manifest_payload(
    ...
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_nested_regret_protocol_manifest_v1",
...
def leakage_report_payload(
    *,
    ...
    payload = {
        "schema_version": "fixed_bank_nested_regret_leakage_report_v1",
        "status": "PASS",
        "probability_surface_hash": probability_surface_hash,
        "nested_plan_seal_hash": str(getattr(preterminal, "plans").seal_hash),
        ...
        "nested_voter_labels_excluded_from_own_endpoint_fit": True,
        ...
        "unordered_pair_fit_reused_for_two_ordered_voters": True,
...
def publication_decision_payload(terminal: object) -> dict[str, object]:
    ...
    return {
        "schema_version": "fixed_bank_nested_regret_publication_decision_v1",
        ...
        "unconfirmed_thesis_specific_mechanism_hypothesis": (
            "outer-center-excluded_nested_donor_regret_with_center-balanced_"
            "partial_pooling_deletion_consensus_point-estimate_proper-loss_"
            "fallback_and_descriptive_center-block_feasibility"
        ),
        "generic_conformal_method_novelty_claimed": False,
        "center_block_feasibility_is_formal_risk_control": False,
...
def run_state_payload(
    *,
    ...
    return {
        "schema_version": "fixed_bank_nested_regret_run_state_v1",
        "status": status,
        "phase": phase,
        "error": error,

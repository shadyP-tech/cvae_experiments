...
SCHEMA = "fixed_bank_nested_regret_workstation_preflight_v1"
...
def load_validated_workstation_preflight(
    ...
    if (
        ...
        or payload.get("unordered_pair_state_count")
        != EXPECTED_UNORDERED_PAIR_COUNT
        or payload.get("ordered_voter_count") != EXPECTED_ORDERED_VOTER_COUNT
        or payload.get("expected_endpoint_model_fit_count")
        != EXPECTED_ENDPOINT_MODEL_FIT_COUNT
        ...
        raise ProtocolError("Nested-regret persisted workstation preflight drifted.")
    return payload

"""V4-owned B/U/A1 physical action specifications.
...
def candidate_sources(target_center: object) -> tuple[str, ...]:
    ...
    if target not in CENTERS:
        raise ProtocolError("OE-PPUR v4 physical target center is unknown.")
...
def a1_action_id(source_center: object) -> str:
    ...
    if source not in CENTERS:
        raise ProtocolError("OE-PPUR v4 physical source center is unknown.")
...
class PhysicalActionSpec:
    ...
    def __post_init__(self) -> None:
        ...
        try:
            ...
            raise ProtocolError(
                "OE-PPUR v4 physical action mapping drifted."
            ) from exc
        ...
        if (
            ...
            raise ProtocolError("OE-PPUR v4 physical action contract drifted.")
        body = {
            "schema_version": "oe_ppur_v4_physical_action_v1",

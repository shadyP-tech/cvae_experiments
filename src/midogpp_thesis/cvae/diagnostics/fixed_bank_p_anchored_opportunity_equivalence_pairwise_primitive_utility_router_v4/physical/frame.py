"""V4-owned label-free consumed-test frame contracts."""
...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("OE-PPUR v4 test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("OE-PPUR v4 label-free test frame drifted.")
        ...
        object.__setattr__(
            ...
            canonical_hash(
                {
                    "schema_version": "oe_ppur_v4_label_free_test_frame_v1",
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "oe_ppur_v4_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("OE-PPUR v4 embedding identity drifted.")

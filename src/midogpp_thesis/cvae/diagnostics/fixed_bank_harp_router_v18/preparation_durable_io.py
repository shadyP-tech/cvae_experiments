"""Durable, deterministic file publication helpers for HARP v18 preparation."""
...
from .preparation_contracts import V18_PREPARATION_IDENTITY
...
def write_cache_rows(
    ...
    *,
    row_schema: str = V18_PREPARATION_IDENTITY.cache_identity.row_schema,
) -> None:
...
def write_content_index(
    ...
    *,
    content_schema: str = V18_PREPARATION_IDENTITY.cache_identity.content_schema,
) -> None:

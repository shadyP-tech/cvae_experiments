"""Immutable, label-free consumed-test DTOs for SCEPTRE v2."""
...
class TestRowIdentity:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("SCEPTRE v2 test-row identity drifted.")
...
class LabelFreeTestFrame:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v2 label-free frame drifted.")
        if self.canonical_coverage and (
            ...
            raise ProtocolError("SCEPTRE v2 canonical whole-case coverage drifted.")
    ...
    def cache_binding_hash(self) -> str:
        return canonical_hash(
            {
                "schema_version": "sceptre_v2_test_cache_binding_v1",
    ...
    def embeddings_for(self, rows: Sequence[TestRowIdentity]) -> np.ndarray:
        ...
        if (
            ...
            raise ProtocolError("SCEPTRE v2 embedding identity drifted.")

...
def load_prediction_surface(
    ...
    *,
    ...
    if (
        index.get("schema_version") != "midogpp_sceptre_v2_prediction_index_v1"
...
def _stage_evaluation_frame(
    ...
    frame_unhashed = {
        "schema_version": "midogpp_sceptre_v2_label_free_evaluation_frame_v1",
...
def _build_tasks(
    *,
    ...
    for ordinal, (training_seed, generation_seed) in enumerate(geometry.seed_cells):
        ...
        identity = {
            "schema_version": "midogpp_sceptre_v2_prediction_task_v1",
...
def _prediction_worker(
    ...
    *,
    ...
    checkpoint_unhashed = {
        "schema_version": "midogpp_sceptre_v2_prediction_checkpoint_v1",
        "status": "COMPLETE",
...
def _load_checkpoint_if_complete(
    ...
    if (
        ...
        != "midogpp_sceptre_v2_prediction_checkpoint_v1"

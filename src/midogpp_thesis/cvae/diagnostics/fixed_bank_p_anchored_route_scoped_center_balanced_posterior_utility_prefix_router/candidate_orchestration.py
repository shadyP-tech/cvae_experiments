    ...
    *,
    ...
    endpoint_jobs = tuple(
        OuterEndpointJob(
            ...
            tuple(
                plan for plan in plans.outer_plans if plan.target_center == center
            ),
            tuple(ordinary_priors[center].items()),
        )
        for center in CENTERS
    )
...
__all__ = ("SealedCandidateProducts", "build_sealed_candidates")

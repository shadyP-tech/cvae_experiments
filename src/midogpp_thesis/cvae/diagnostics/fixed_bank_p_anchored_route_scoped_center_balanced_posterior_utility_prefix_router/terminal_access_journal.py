"""Irreversible terminal-label access journal for CBPUPR v2."""
...
from .constants import EXPERIMENT_ID, EXPECTED_TEST_ROW_COUNT, OUTPUT_ARTIFACT_ID
...
def persist_terminal_label_access_intent(
    ...
    payload = {
        "schema_version": "fixed_bank_cbpupr_terminal_label_access_intent_v1",
...
def persist_terminal_label_access_opened_receipt(
    ...
    *,
    ...
    payload = {
        "schema_version": (
            "fixed_bank_cbpupr_terminal_label_access_opened_receipt_v1"
        ),
        "experiment_id": EXPERIMENT_ID,
        "output_artifact_id": OUTPUT_ARTIFACT_ID,
...
def validate_terminal_label_access_intent(
    ...
    if (
        ...
        != "fixed_bank_cbpupr_terminal_label_access_intent_v1"

...
class OuterScienceResult:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "result_hash", canonical_sha256({
            "schema": "oe_ppur_v3_outer_science_result_v2",
            "H": h,
            "plan_hash": plan_hash,
...
def fit_outer_source_science(
    ...
    *,
    ...
    if not isinstance(source_surface, SourceTrainingSurface) or not isinstance(plan, OuterFoldPlanV3):
        raise ProtocolError("OE-PPUR v3 nominal science requires typed surface and plan.")
    if (
        ...
        raise ProtocolError("OE-PPUR v3 nominal surface/plan lineage drifted.")
    ...
    if (
        ...
        raise ProtocolError("OE-PPUR v3 nominal row OOF coverage drifted.")
    ...
    if not isinstance(policy, BaccRankingPolicy):
        raise ProtocolError("OE-PPUR v3 nominal ranking policy is untyped.")
    ...
    *,
    ...
    try:
        ...
        evidence_hash = canonical_sha256({
            "schema": "oe_ppur_v3_nominal_fail_closed_exception_v1",
            "plan_hash": plan.plan_hash,

"""Compact whole-artifact seal composer for OE-PPUR v3."""
...
def build_complete_artifact_seal(
    ...
    *,
    ...
    if (
        ...
        raise ProtocolError("OE-PPUR v3 complete artifact changed while sealing.")
...
def validate_complete_artifact_seal(
    ...
    *,
    ...
    if type(expected) is not CompleteArtifactSealReceipt:
        raise ProtocolError("OE-PPUR v3 complete artifact validation is untyped.")
    destination = _safe_artifact_root(root)
    _validate_exact_artifact_inventory(destination, index_present=True)
    ...
    if (
        ...
        raise ProtocolError("OE-PPUR v3 complete artifact content hashes drifted.")
    ...
    if (
        ...
        raise ProtocolError("OE-PPUR v3 complete artifact semantic seal drifted.")
    ...
    if observed != expected:
        raise ProtocolError("OE-PPUR v3 complete artifact seal receipt drifted.")
    return observed

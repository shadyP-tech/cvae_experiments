"""Leakage, routing, and terminal report construction for HARP v14."""
...
def build_leakage_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "midogpp_harp_v14_leakage_report_v1",
...
def write_terminal_reports(
    ...
    *,
    ...
    atomic_json(
        ...
        {
            "schema_version": "midogpp_harp_v14_evaluation_label_access_v1",
    ...
    validation_report = {
        "schema_version": "midogpp_harp_v14_validation_report_v1",
        "status": "PASS",

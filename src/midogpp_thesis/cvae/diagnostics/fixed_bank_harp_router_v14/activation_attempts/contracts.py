"""Typed identities for archived HARP v14 activation attempts."""
...
SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V14_ROLLED_BACK_ACTIVATION_FOR_REPLANNING"
)
SUPERSESSION_PLAN_SCHEMA = "midogpp_harp_stage90_activation_supersession_plan_v14"
SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_activation_supersession_receipt_v14"
)
...
SUPERSEDED_ROOT_RELATIVE = (
    ...
    "harp_router_v14/superseded_activations"
)
...
ACTIVE_SUPERSESSION_CONFIRMATION = (
    "ARCHIVE_HARP_V14_ACTIVE_UNCONSUMED_PRELEASE_ACTIVATION_FOR_REPLANNING"
)
ACTIVE_SUPERSESSION_PLAN_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_plan_v14"
)
ACTIVE_SUPERSESSION_RECEIPT_SCHEMA = (
    "midogpp_harp_stage90_active_activation_supersession_receipt_v14"
)
...
RETIREMENT_FENCE_SCHEMA = "midogpp_harp_v14_active_supersession_retirement_fence_v1"
ACTIVE_SUPERSESSION_RECEIPT = "active_supersession_receipt.json"


@dataclass(frozen=True, slots=True)
class HarpV14ActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV14ActivationSupersessionReceipt:
...
@dataclass(frozen=True, slots=True)
class HarpV14ActiveActivationSupersessionPlan:
...
@dataclass(frozen=True, slots=True)
class HarpV14ActiveActivationSupersessionReceipt:
    payload: Mapping[str, object]
...
def receipt_payload(plan: HarpV14ActivationSupersessionPlan) -> dict[str, object]:
    body = {
        **plan.hash_payload(),

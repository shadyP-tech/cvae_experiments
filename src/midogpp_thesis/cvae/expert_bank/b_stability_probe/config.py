...
def load_stability_config(path: str | Path) -> StabilityConfig:
    ...
    gates = {
        ...
        "mean_preservation_delta_vs_terminal_min": -0.02,
        "worst_center_preservation_delta_vs_terminal_min": -0.05,
        "mean_recall_delta_vs_terminal_min": -0.03,
        "mean_specificity_delta_vs_terminal_min": -0.03,
        "center_5_mean_recall_delta_vs_terminal_min": -0.05,
        "center_5_mean_specificity_delta_vs_terminal_min": -0.05,
        "center_9_mean_recall_delta_vs_terminal_min": -0.05,
        "center_9_mean_specificity_delta_vs_terminal_min": -0.05,

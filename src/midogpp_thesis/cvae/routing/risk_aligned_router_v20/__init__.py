"""HARP v20 risk-adjusted proposer and independently nested winner gate.
...
from .outcome_model import ActionOutcomeModel, ActionOutcomePrediction, fit_action_outcome_model
from .aligned_metrics import ClassSupportNormalizer
from .stacked_fitting import StackedScienceModel, WinnerGateModel, WinnerGatePrediction, fit_stacked_science_model
from .model_integrity import verify_complete_model_payload
from .policy import (
    PooledRouterPolicy,
    fit_source_router,
...
__all__ = (
    "CandidateComposite", "build_candidate_composites", "ProposalModel", "fit_proposal_model",
    "ActionOutcomeModel", "ActionOutcomePrediction", "fit_action_outcome_model",
    "ClassSupportNormalizer", "CompositeOutcome", "StackedScienceModel",
    "WinnerGateModel", "WinnerGatePrediction", "fit_stacked_science_model", "verify_complete_model_payload",
    "AdmissionStatus",
    "ApproximateSourceOOFBounds",
    "ArmSpec",
    "BASELINE_THRESHOLD",

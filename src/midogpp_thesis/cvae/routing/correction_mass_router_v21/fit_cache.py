...
class ScopedFitCache:
    ...
    def key(self, kind, menus, capability, config):
        ...
        if kind == 'ranker':
            fit_config.pop('evidence_variant')
        return canonical_hash({"kind": kind,
            ...
            "config": fit_config, "execution_namespace": "HARP_V21"})
    ...
    def public_payload(self):
        return {"maximum_entries": self.maximum_entries,
                ...
                "variant_independent_ranker_shared_only_inside_exact_scope": True,
                "proposer_and_complete_learner_keys_include_evidence_variant": True}

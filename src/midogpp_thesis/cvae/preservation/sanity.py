...
DEFAULT_ARTIFACT_ROOT = (
    ...
    "virchow2_cvae_midogpp_preservation_sanity_v1/seed42"
)
DEFAULT_MANIFEST_PATH = "datasets/midogpp/contract/annotation_patch_v1/manifest.csv"
DEFAULT_FEATURE_CACHE_PATH = (
    "datasets/midogpp/derived/features/virchow2/"
    "annotation_patch_xyxy/seed42/embeddings/train.pt"
)
DEFAULT_SIGNAL_SPLIT_MANIFEST_PATH = (
    "artifacts/midogpp/10_real_feature_reference/"
    "midogpp_virchow2_real_feature_signal_controls/v1/tables/split_manifest.csv"
)
DEFAULT_SIGNAL_DECISION_REPORT_PATH = (
    "artifacts/midogpp/10_real_feature_reference/"
    "midogpp_virchow2_real_feature_signal_controls/v1/reports/decision_report.md"
)

"""Data-only contracts shared by HARP v17 physical execution modules."""
...
class PhysicalInputReceipt:
    ...
    cache_hash: str
    support_independence: FixedBankSupportIndependenceAttestation
    receipt_hash: str

    @property
    def bank_independence(self) -> FixedBankSupportIndependenceAttestation:
        return self.support_independence
    ...
    def public_payload(self) -> dict[str, object]:
        return {
            ...
            "bank_independence_attestation": self.bank_independence.to_payload(),
            "bank_independence_attestation_hash": self.bank_independence.attestation_hash,

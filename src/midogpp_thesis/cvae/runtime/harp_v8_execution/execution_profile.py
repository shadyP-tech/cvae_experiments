"""Typed, fail-closed workstation topology for HARP v8 execution."""
...
class WorkstationProfile:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("HARP v8 workstation execution profile drifted.")
    ...
    def public_payload(self) -> dict[str, object]:
        return {
            "schema_version": "midogpp_harp_v8_workstation_profile_v1",

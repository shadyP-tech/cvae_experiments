"""Typed digest-width contracts for HARP v5 runtime boundaries."""
...
def require_sha256(value: object, *, name: str) -> str:
    ...
    if (
        ...
        raise ProtocolError(f"HARP v5 {name} is malformed.")
    return value
...
def runtime_hash_contract_payload() -> Mapping[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_v5_runtime_hash_contract_v2",

"""Typed, fail-closed workstation topology for HARP v6 execution."""
...
class WorkstationProfile:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ProtocolError("HARP v6 workstation execution profile drifted.")
    ...
    def public_payload(self) -> dict[str, object]:
        return {
            "schema_version": "midogpp_harp_v6_workstation_profile_v1",

"""Durable source-only model and learnability-admission artifacts for HARP v6."""
...
def build_source_router_artifact(
    ...
    *,
    ...
    if not observations or any(
        ...
        raise ProtocolError("HARP v6 source-development observations are untyped.")
    ...
    if any(
        ...
        raise ProtocolError("HARP v6 model rows escaped sealed compatibility receipts.")
    fitted = fit_fn(
        observations,

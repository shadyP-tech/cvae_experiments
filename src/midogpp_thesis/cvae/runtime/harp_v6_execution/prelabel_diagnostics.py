"""Label-free accounting for HARP v6 routing and abstention reasons."""
...
def build_prelabel_diagnostics(routes: PrelabelRouteSet) -> Mapping[str, object]:
    if not isinstance(routes, PrelabelRouteSet):
        raise ProtocolError("HARP v6 prelabel diagnostics require typed routes.")
    ...
    body = {
        "schema_version": "midogpp_harp_v6_prelabel_rejection_diagnostics_v1",

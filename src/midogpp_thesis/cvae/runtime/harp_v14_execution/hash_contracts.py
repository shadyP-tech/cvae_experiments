"""Typed digest-width contracts for HARP v14 runtime boundaries."""
...
CANONICAL_SHA256_FIELD_PATHS = (
    ...
    "source_only_model.model_hash",
    "support_compatibility.compatibility_hash",
    "source_only_admission.admission_hash",
...
def require_sha256(value: object, *, name: str) -> str:
    ...
    if (
        ...
        raise ProtocolError(f"HARP v14 {name} is malformed.")
    return value
...
def runtime_hash_contract_payload() -> Mapping[str, object]:
    ...
    body: dict[str, object] = {
        "schema_version": "midogpp_harp_v14_runtime_hash_contract_v2",
        ...
        "soft_route_formula_reconstructed_from_physical_components": True,
    }

"""V16-owned leakage-safe exact-B, matched-budget U, and Hxe action algebra.
...
# Compatibility name for neutral runtime helpers.  V16 never constructs the
...
class HarpActionSpec:
    ...
    def __post_init__(self) -> None:
        ...
        if query != outer:
            raise ProtocolError("HARP v16 support/target actions require q == H.")
...
def build_development_action_menu(
    ...
    if query != outer:
        raise ProtocolError("HARP v16 support query must equal target H.")

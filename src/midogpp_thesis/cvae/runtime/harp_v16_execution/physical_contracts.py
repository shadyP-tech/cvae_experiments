"""Data-only contracts shared by HARP v16 physical execution modules."""
...
class PhysicalInputReceipt:
    ...
    def public_payload(self) -> dict[str, object]:
        return {
            ...
            "support_independence_attestation": self.support_independence.to_payload(),
            "support_independence_attestation_hash": self.support_independence.attestation_hash,

...
class BuilderConfig:
    ...
    def from_mapping(cls, data: Mapping[str, Any], *, repo_root: Path | None = None) -> "BuilderConfig":
        ...
        default_contract_name = artifact_name.removeprefix("midogpp_")
        artifact_root = _config_path(
            root,
            artifact.get("root", f"datasets/midogpp/contract/{default_contract_name}"),
        )
        input_root = _config_path(root, inputs.get("root", "datasets/midogpp/raw/MIDOGpp"))

...
from midogpp_thesis.cvae.runtime.harp_v5_execution import workstation
...
from midogpp_thesis.cvae.runtime.harp_v5_execution.physical import (
    build_physical_plan,
)
from midogpp_thesis.cvae.runtime.harp_v5_execution.science_pool import (
    lpt_batches,
    science_pool_plan,
)
...
def test_v5_plan_separates_gpu_classifier_and_science_pools() -> None:
...
def test_live_preflight_requires_global_single_thread_parent(
    ...
    report = workstation.inspect_harp_v5_workstation(_runtime())
    ...
    with pytest.raises(ProtocolError, match="launch through workspace run"):
        workstation.inspect_harp_v5_workstation(_runtime())
...
def test_gpu_surface_never_sets_late_torch_interop_threads() -> None:
    ...
    source = (
        root
        / "src/midogpp_thesis/cvae/runtime/harp_v5_execution/gpu_surface.py"

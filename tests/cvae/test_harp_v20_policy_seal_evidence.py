...
from midogpp_thesis.cvae.routing.risk_aligned_router_v20.candidate_prediction import POLICY_ARM_ID
from midogpp_thesis.cvae.routing.risk_aligned_router_v20.composition import build_baseline_composite, build_exact_u_composite
from test_harp_v20_science_foundation import make_menu, seal
...
def test_empty_target_winner_retains_exact_baseline_without_source_only_fields(admitted,reason):
    ...
    from midogpp_thesis.cvae.routing.risk_aligned_router_v20 import SurfaceRole

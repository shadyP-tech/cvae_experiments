...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v7 import authorization
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v7.workstation_preparation import (
...
CONTRACT_RELATIVE = Path(
    "experiments/midogpp/stages/90_oracles_and_diagnostics/contracts/harp_router_v7"
)
...
def test_v7_contract_scaffold_supports_mutation_free_preparation_planning(
    tmp_path: Path,
) -> None:
    ...
    plan = plan_harp_v7_workstation_preparation(repository)

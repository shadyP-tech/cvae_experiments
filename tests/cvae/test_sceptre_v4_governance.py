...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4 import runner
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.config import (
    CLASSIFIER,
    experiment_payload,
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.execution.inputs import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.identity import (
    AUTHORIZATION_BASIS,
    AUTHORIZATION_SCOPE,
    CLI_SURFACE,
    EXPERIMENT_ID,
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.physical.prediction_contracts import (
    CANDIDATE_ARRAY_MEMBER,
    EXACT_B_ARRAY_MEMBER,
    PREDICTION_INDEX_MEMBER,
    PREDICTION_RECEIPT_MEMBER,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.protocol import (
    claim_boundary_payload,
    protocol_payload,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v4.execution.workstation import (
    workstation_payload,
)
...
CONFIG = (
    ...
    / "uniform_b_v2_consumed_test_fixed_bank_sceptre_router_v4.yaml"
)
CONTRACT_ROOT = (
    ROOT
...
def test_inspection_is_path_free_and_mutation_free(tmp_path: Path) -> None:
    ...
    receipt = runner.inspect_sceptre_v4(config)
...
def test_v4_scoped_inputs_are_single_consumer_authorized_and_predecessor_free() -> None:
    workspace = MidogppWorkspace.load(ROOT)

...
from midogpp_thesis.cvae.runtime.harp_v19_execution.hash_contracts import (
    runtime_hash_contract_payload,
)
from midogpp_thesis.cvae.runtime.harp_v19_execution.physical import (
    build_physical_plan,
)
from midogpp_thesis.cvae.runtime.harp_v19_execution.science_pool import (
    science_pool_plan,
)
...
from midogpp_thesis.cvae.runtime.harp_v19_execution.terminal import (
...
def test_v19_preserves_the_bounded_81_task_810_fit_workstation_plan() -> None:
...
def test_runtime_is_predecessor_free_and_has_no_late_torch_thread_setter() -> None:
    runtime_root = (
        ...
        / "src/midogpp_thesis/cvae/runtime/harp_v19_execution"
    )

...
from midogpp_thesis.cvae.routing.hierarchical_support_action_risk_router_v15.hashing import (
    canonical_hash,
)
...
from midogpp_thesis.cvae.runtime.harp_v15_execution.prelabel_diagnostics import (
    build_prelabel_diagnostics,
)
from midogpp_thesis.cvae.runtime.harp_v15_execution.stores import (
    write_label_free_outer_menu,
)
from midogpp_thesis.cvae.runtime.harp_v15_execution.support_independence import (
    FixedBankSupportIndependenceAttestation,
)
from midogpp_thesis.cvae.runtime.harp_v15_execution.support_model_artifacts import (
    build_support_outcome_artifact,
    build_support_router_artifact,
    build_support_target_routes,
    report_support_router_artifact,
)
from midogpp_thesis.cvae.runtime.harp_v15_execution.support_surface_seals import (
    report_support_target_surface_seals,
    write_support_target_surface_seals,
)
from midogpp_thesis.cvae.runtime.harp_v15_execution.support_target_adapter import (
...
def _physical_menu(*, support_cases: int = 12, target_cases: int = 2) -> LabelFreeOuterMenu:
    ...
    return LabelFreeOuterMenu(
        ...
        lineage={"fixture": "v15-support-target"},
    )

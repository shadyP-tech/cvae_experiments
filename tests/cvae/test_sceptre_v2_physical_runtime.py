...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2 import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.source_streams import (
...
def test_production_geometry_and_public_api_are_frozen() -> None:
    ...
    assert "torch.set_num_threads(1)" in generation_worker_source
    assert "torch.set_num_interop_threads(1)" in generation_worker_source

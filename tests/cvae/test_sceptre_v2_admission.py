...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.protocol import (
...
def _config(tmp_path: Path, artifact_root: Path) -> SceptreV2Config:
...
def test_v2_identity_and_claim_boundary_are_terminal_only() -> None:
    claim = claim_boundary_payload()
    assert EXPERIMENT_ID.endswith(".v2")

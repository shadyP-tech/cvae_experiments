...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v19.execution.source_diagnostics import (
...
def test_source_reports_persist_prediction_outcome_joins_without_raw_labels(tmp_path):
    from test_harp_v19_nested_policy import _source_surface, _config

...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13 import authorization
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13.activation_attempts import (
    active_audit as supersession_audit,
    admin_snapshot,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13.activation_attempts.contracts import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13.activation_supersession import (
    plan_harp_v13_active_activation_supersession,
    supersede_harp_v13_active_activation,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v13.activation_transaction import (
    ActivationJournal,
...
OLD_SOURCE = {
    "source_snapshot_schema": "midogpp_harp_stage90_source_snapshot_v13",
...
def _plan_absent_output(
    ...
    return plan_harp_v13_active_activation_supersession(repository)


def _admin_plan(repository: Path, journal: ActivationJournal) -> HarpV13ActiveActivationSupersessionPlan:
    ...
    manifest_body = {
        "schema_version": "midogpp_harp_v13_workspace_admin_snapshot_v1",
        "experiment_id": EXPERIMENT_ID,
    ...
    provisional = HarpV13ActiveActivationSupersessionPlan(
        ...
        archive_root=(
            ...
            "harp_router_v13/superseded_active_activations"
...
def _plan_admin_output(
    ...
    plan = plan_harp_v13_active_activation_supersession(repository)
...
def test_active_plan_is_mutation_free_and_requires_source_drift(
    ...
    with pytest.raises(ProtocolError, match="source snapshot is unchanged"):
        plan_harp_v13_active_activation_supersession(repository)
...
def test_active_supersession_archives_then_restores_registry_first(
    ...
    receipt = supersede_harp_v13_active_activation(
        plan,
...
def test_active_supersession_rejects_wrong_token_without_mutation(
    ...
    with pytest.raises(ProtocolError, match="confirmation"):
        supersede_harp_v13_active_activation(plan, confirmation="wrong")
...
def test_every_injected_crash_resumes_idempotently(
    ...
    resumed = plan_harp_v13_active_activation_supersession(repository)
...
def test_delayed_preloaded_authorization_cannot_claim_after_supersession(
    ...
    delayed = authorization.HarpV13Authorization(

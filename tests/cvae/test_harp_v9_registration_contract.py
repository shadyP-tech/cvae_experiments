...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v9.activation_workspace import (
    validate_rendered_workspace,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v9.amendment_publisher import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v9.identity import (
    EXPERIMENT_ID,
    OUTPUT_ARTIFACT_ID,
)
...
def test_v9_config_freezes_train_crossfit_full_test_and_workstation_geometry() -> None:
...
def test_v9_catalog_and_registry_bind_center_shards_and_crossfit_outputs() -> None:

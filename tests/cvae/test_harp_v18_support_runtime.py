...
from midogpp_thesis.cvae.runtime.harp_v18_execution.contracts import (
    ActionKind,
    LabelFreeActionBlock,
    LabelFreeOuterMenu,
)
from midogpp_thesis.cvae.runtime.harp_v18_execution.prelabel_diagnostics import (
    build_prelabel_diagnostics,
)
from midogpp_thesis.cvae.runtime.harp_v18_execution.journal import (
...
from midogpp_thesis.cvae.runtime.harp_v18_execution.support_target_adapter import (
    FULL_U_ARM_ID,
...
def _physical_menu(
    ...
    return LabelFreeOuterMenu(
        ...
        lineage={"fixture": "v18-source-q-target-H", "center": center},
    )
...
def test_workstation_model_config_is_explicitly_translated_to_science_config() -> None:
    ...
    raw["schema_version"] = (
        "midogpp_harp_stage90_case_conditional_composite_router_v18"
    )
...
def test_single_pooled_policy_fits_all_source_centers_and_routes_all_targets(tmp_path, monkeypatch) -> None:
    ...
    from midogpp_thesis.cvae.routing import case_conditional_composite_router_v18 as science
    from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v18.execution.source_diagnostics import write_source_diagnostics
    ...
    frontier, headroom = (json.loads(p.read_text()) for p in paths)
...
def test_recovery_materializes_only_centers_without_complete_checkpoints(tmp_path) -> None:
    from midogpp_thesis.cvae.diagnostics.fixed_bank_harp_router_v18.runner_recovery import (

...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.development_orchestrator import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.fresh_process_validation import (
    require_two_fresh_final_validations,
    require_two_fresh_preterminal_validations,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.label_broker import (
    RoleLabelBroker,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.outcome_builder import (
    build_role_evidence,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.prediction_surface import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.persistence import (
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.phase_orchestrator import (
    run_routing_phases,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.reports import (
    build_final_reports,
...
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.terminal_evaluation import (
    evaluate_terminal_surfaces,
)
from midogpp_thesis.cvae.diagnostics.fixed_bank_sceptre_router_v2.validation import (
...
def _development(frozen_fixture, partition) -> FrozenDevelopmentReplay:
    ...
    body = {
        "schema_version": "sceptre_v2_label_free_development_replay_v1",
...
def _prediction_members(
    ...
    *,
    ...
    index_body = {
        "schema_version": "midogpp_sceptre_v2_prediction_index_v1",
    ...
    receipt_body = {
        "schema_version": "midogpp_sceptre_v2_prediction_receipt_v1",

...
with better latent priors, and heldout-excluded reliability can improve dense
all-source aggregation. Decentralized sparse source selection signals have not
yet produced a full PASS.
...
- Keep the paired dense all4 result scoped to dense aggregation, not final
  sparse routing.
- Document D1.5 as negative evidence before proposing further source-inner
  transfer variants.

...
- The latest generated-embedding experiments shift the CVAE bottleneck toward
  latent prior sampling, decentralized composition, and source-mass/tail-risk
...
preserved and that component-level composition has high mean-utility capacity.

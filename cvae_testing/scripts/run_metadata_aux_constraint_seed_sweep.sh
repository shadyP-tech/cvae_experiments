...
# Run metadata auxiliary-constraint legacy routed experiments with thesis-canonical seeds.
# Scope: 2 datasets x 1 constrained config each x 3 seeds = 6 runs.
...
SEEDS=(11 42 73)
CONFIGS=(
  "configs/experiments/breakhis/routed_cvae_metadata_aux_constraint_v1.yaml"
  "configs/experiments/camelyon17/routed_cvae_metadata_aux_constraint_v1.yaml"
)

BREAKHIS_MANIFEST="results/comparison_tables/legacy_conditioning_breakhis_aux_constraint_manifest.txt"
CAMELYON_MANIFEST="results/comparison_tables/legacy_conditioning_camelyon17_aux_constraint_manifest.txt"
...
echo "Starting metadata auxiliary-constraint seed sweep (6 runs)."
...
echo "Completed metadata auxiliary-constraint sweep."

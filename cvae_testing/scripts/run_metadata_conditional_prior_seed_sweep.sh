...
# Run metadata conditional-prior legacy routed experiments with thesis-canonical seeds.
# Scope: 2 datasets x 1 conditional-prior config each x 3 seeds = 6 runs.
...
SEEDS=(11 42 73)
CONFIGS=(
  "configs/experiments/breakhis/routed_cvae_metadata_conditional_prior_v1.yaml"
  "configs/experiments/camelyon17/routed_cvae_metadata_conditional_prior_v1.yaml"
)

BREAKHIS_MANIFEST="results/comparison_tables/legacy_conditioning_breakhis_conditional_prior_manifest.txt"
CAMELYON_MANIFEST="results/comparison_tables/legacy_conditioning_camelyon17_conditional_prior_manifest.txt"
...
echo "Starting metadata conditional-prior seed sweep (6 runs)."
...
echo "Completed metadata conditional-prior sweep."

...
from sail.features import read_manifest_rows_by_split  # noqa: E402


def test_read_manifest_resolves_repo_relative_image_paths(tmp_path: Path, monkeypatch) -> None:
    monkeypatch.chdir(tmp_path)
    image_path = tmp_path / "datasets/midogpp/artifacts/midogpp_annotation_patch_v1/patches_224/sample.jpg"
    image_path.parent.mkdir(parents=True)
    image_path.write_bytes(b"fake image bytes")
    manifest_path = tmp_path / "datasets/midogpp/artifacts/midogpp_annotation_patch_v1/manifest.csv"
    _write_manifest(manifest_path, "datasets/midogpp/artifacts/midogpp_annotation_patch_v1/patches_224/sample.jpg")

...
from sail.midogpp_multiaxis import _read_manifest  # noqa: E402
from sail.midogpp_signal_controls import (  # noqa: E402
    BALANCED_CONTROL,
    LOGISTIC_MODEL_TYPE,
...
""",
    ...
    result = subprocess.run(
        [sys.executable, "-m", "sail.cli", "run-midogpp-signal-controls", "--config", str(config_path)],
        cwd=tmp_path,
        env=env,
        text=True,

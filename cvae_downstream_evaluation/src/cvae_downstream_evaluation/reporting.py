    ...
    *,
    ...
    for unit in selections:
        ...
        for context_key in contexts:
            heldout, generation_mode, budget, generation_seed, classifier_seed = context_key
            if heldout != unit.heldout_center:
                continue
            selected_key = (
                unit.heldout_center,
...
def _spearman_neg_nelbo_vs_bacc(
    ...
    rows_by_key: Mapping[tuple[str, str, str, int, int, int], CandidateDownstreamRow],

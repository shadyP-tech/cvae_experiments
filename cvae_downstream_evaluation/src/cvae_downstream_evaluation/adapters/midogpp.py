        ...
        summaries.append(
            {
                ...
                "threshold_policy": template.threshold_policy,
                "threshold_value": template.threshold_value,
                "threshold_policy_group_id": template.threshold_policy_group_id,
...
def build_midogpp_phase1_leakage_report(
    *,
    ...
    report = {
        ...
        "threshold_tuned_on_target_eval": False,
...
def _baseline_context_key(row: MidogppDownstreamRow | Mapping[str, object]) -> tuple[object, ...]:
    ...
    return (
        ...
        row["classifier_seed"],
        row["synthetic_per_class_total"],
        row.get("threshold_policy", "fixed_0_5"),
        row.get("threshold_value", 0.5),
        row.get("threshold_policy_group_id", "fixed_0_5"),
        row["config_hash"],
        row["protocol_hash"],
        row["feature_frame_hash"],
    )

...
This page is an archived historical document from the retired `cvae_downstream_evaluation`
structure. It is preserved for context only and is **not** active guidance for the
current `src/midogpp_thesis` workspace.
